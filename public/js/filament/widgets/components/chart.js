...
var wn = (s) => (s <= 0.0031308 ? s * 12.92 : s ** (1 / 2.4) * 1.055 - 0.055),
	Ne = (s) => (s <= 0.04045 ? s / 12.92 : ((s + 0.055) / 1.055) ** 2.4);
function nh(s, t, e) {
	const i = Ne(Wt(s.r)),
		n = Ne(Wt(s.g)),
		r = Ne(Wt(s.b));
...
function So(s, t, e) {
	...
	const i = t[s],
		n = e[s];
	E(i) && E(n) ? pe(i, n) : Object.hasOwn(t, s) || (t[s] = ys(n));
}
...
var _i = (() =>
	typeof window > "u" ? (s) => s() : window.requestAnimationFrame)();
function wi(s, t) {
	let e = [],
		i = !1;
	return (...n) => {
...
function ki(s, t, e) {
	let i = t.length,
		...
		r = i;
	if (s._sorted) {
		const { iScale: o, vScale: a, _parsed: l } = s,
...
var ai = (s) => s === 0 || s === 1,
	go = (s, t, e) => -(2 ** (10 * (s -= 1)) * Math.sin(((s - t) * H) / e)),
	mo = (s, t, e) => 2 ** (-10 * s) * Math.sin(((s - t) * H) / e) + 1,
	fe = {
		linear: (s) => s,
		easeInQuad: (s) => s * s,
		easeOutQuad: (s) => -s * (s - 2),
		...
		easeInExpo: (s) => (s === 0 ? 0 : 2 ** (10 * (s - 1))),
		easeOutExpo: (s) => (s === 1 ? 1 : -(2 ** (-10 * s)) + 1),
		easeInOutExpo: (s) =>
			ai(s)
				? s
				: s < 0.5
...
var Po = {
	...
	logarithmic(s, t, e) {
		if (s === 0) return "0";
		const i = e[t].significand || s / 10 ** Math.floor(Et(s));
...
function Oi(s, t, e, i, n) {
	...
	if (!(isNaN(m) || m <= 0)) {
		switch ((s.beginPath(), f)) {
			...
			case "dash":
				s.moveTo(e, i),
					s.lineTo(e + Math.cos(p) * (n ? n / 2 : m), i + Math.sin(p) * m);
				break;
			case !1:
				s.closePath();
				break;
...
function Eo(s, t, e) {
	if (Object.hasOwn(s, t) || t === "constructor") return s[t];
	const i = e();
	return (s[t] = i), i;
}
function kh(s, t, e) {
		...
		(y = t[M % o]),
			!y.skip &&
				...
				b !== _ &&
					...
					p !== null &&
						v() &&
						(g.push(xo({ start: p, end: M, loop: d, count: o, style: f })),
						(p = null)),
					(O = M),
					(_ = b)));
	return (
		p !== null && g.push(xo({ start: p, end: u, loop: d, count: o, style: f })),
		g
	);
}
function Ni(s, t) {
...
function jh(s, t) {
	if (!t) return !1;
	const e = [],
		i = (n, r) => (Si(r) ? (e.includes(r) || e.push(r), e.indexOf(r)) : r);
...
function zi(s, t) {
	...
	return {
		...
		bottom:
			e.bottom === !1 ? s.height : i.bottom + (e.bottom === !0 ? 0 : e.bottom),
	};
}
var cr = class {
		constructor() {
...
var tr = (s) => s === "reset" || s === "none",
	...
	dt = class {
		...
		parsePrimitiveData(t, e, i, n) {
			...
			for (d = 0, f = n; d < f; ++d)
				(g = d + i),
					(u[d] = { [a]: h || r.parse(c[g], g), [l]: o.parse(e[g], g) });
			return u;
		}
		...
		_resolveElementOptions(t, e = "default", i) {
			...
			return (
				m.$shared && ((m.$shared = l), (r[o] = Object.freeze(Yo(m, l)))), m
			);
		}
...
function uu(s, t, e, i) {
	...
	const { start: o, end: a, reverse: l, top: c, bottom: h } = hu(s);
	n === "middle" &&
		e &&
...
var Ue = class extends dt {
	...
	_getAxis() {
		...
		for (const i of this.chart.data.datasets)
			t[P(this.chart.options.indexAxis === "x" ? i.xAxisID : i.yAxisID, e)] =
				!0;
		return Object.keys(t);
	}
	...
	_calculateBarValuePixels(t) {
		...
		if (b === e.getPixelForValue(a)) {
			const y = (yt(m) * e.getLineWidthForValue(a)) / 2;
			(b += y), (m -= y);
		}
	...
	_calculateBarIndexPixels(t, e) {
		...
		if (e.grouped) {
			const h = r ? this._getStackCount(t) : e.stackCount,
...
var Ye = class extends dt {
	...
	resolveDataElementOptions(t, e) {
		...
		const r = n.radius;
		return (
			e !== "active" && (n.radius = 0), (n.radius += P(i && i._custom, r)), n
		);
	}
};
S(Ye, "id", "bubble"),
...
var qt = class extends dt {
	...
	updateElements(t, e, i, n) {
		...
		for (y = e; y < e + i; ++y) {
			...
			p &&
				(x.options =
					m || this.resolveDataElementOptions(y, w.active ? "active" : n)),
				(b += _),
	...
	updateElements(t, e, i, n) {
		...
		for (let x = 0; x < _; ++x) {
			...
			(v.skip = isNaN(D) || isNaN(A) || O),
				...
				u &&
					(v.options =
						h || this.resolveDataElementOptions(x, k.active ? "active" : n)),
...
var qe = class extends dt {
	...
	update(t) {
		...
		if (((i.points = n), t !== "resize")) {
			...
			const a = { _loop: !0, _fullLoop: r.length === n.length, options: o };
...
function pu(s, t, e, i) {
	...
	if (a && t === a.axis && t !== "r" && o && r.length) {
		const c = a._reversePixels ? Fn : Mt;
		if (i) {
			if (n._sharedOptions) {
				const h = r[0],
...
function Mu(s, t, e, i) {
	...
	const a = Math.max(0, t.outerWidth - Ko(o, s, "left", "right")),
...
var ot = {
		...
		update(s, t, e, i) {
			if (!s) return;
			const n = st(s.options.layout.padding),
...
function Eu(s, t, e) {
	const i = s.canvas,
		n = new MutationObserver((r) => {
			let o = !1;
			for (const a of r)
				(o = o || Gi(a.addedNodes, i)), (o = o && !Gi(a.removedNodes, i));
			o && e();
		});
...
function Lu(s, t, e) {
	const i = s.canvas,
		n = new MutationObserver((r) => {
			let o = !1;
			for (const a of r)
				(o = o || Gi(a.removedNodes, i)), (o = o && !Gi(a.addedNodes, i));
			o && e();
		});
	return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
function Vu(s) {
	return !Cs() || (typeof OffscreenCanvas < "u" && s instanceof OffscreenCanvas)
		? dr
		: fr;
}
var ft = class {
...
function Ku(s, t, e, i) {
	...
	if (s.isHorizontal()) {
		if (((f = et(i, r, a)), E(e))) {
			...
			e === "center" ? (g = (c.bottom + c.top) / 2 + m - t) : (g = sa(s, e, t));
		d = a - r;
	} else {
		if (E(e)) {
			const b = Object.keys(e)[0],
			...
			e === "center" ? (f = (c.left + c.right) / 2 - p + t) : (f = sa(s, e, t));
...
var Ce = class s extends ft {
			...
			for (u = 0; u < e; u += l) {
				if (
					...
					for (d = 0, f = g.length; d < f; ++d)
						(x = g[d]),
							!I(x) && !B(x) && ((_ = ze(n, b.data, b.gc, _, x)), (w += y));
		...
		_computeLabelItems(t) {
			...
			for (b = 0, y = a.length; b < y; ++b) {
				(_ = a[b]), (w = _.label);
				const V = r.setContext(this.getContext(b));
...
function Qu(s, t, e) {
	const i = me(Object.create(null), [e ? j.get(e) : {}, j.get(t), s.defaults]);
	j.set(t, i),
...
function br(s, ...t) {
	...
	for (const e of t) {
		const i =
			e.axis || ld(e.position) || (s.length > 1 && oa(s[0].toLowerCase()));
		if (i) return i;
	}
	throw new Error(
...
var Fs = (s, t, e) => {
	...
	yr = class {
		...
		createResolver(t, e, i = [""], n) {
			const { resolver: r } = ca(this._resolverCache, t, i);
...
function fd(s, t) {
	const { isScriptable: e, isIndexable: i } = Ci(s);
	for (const n of t) {
		const r = e(n),
			o = i(n),
			a = (o || r) && s[n];
...
function ua(s, t) {
	return (e, i) => (e[s] === i[s] ? e[t] - i[t] : e[s] - i[s]);
}
function da(s) {
	const t = s.chart,
...
function xd(s, t, e) {
	...
	if ((s.beginPath(), s.arc(n, r, o - c / 2, i + u / 2, e - u / 2), a > 0)) {
		const d = Math.min(c / a, tt(i - e));
		s.arc(n, r, a + c / 2, e - d / 2, i + d / 2, !0);
	} else {
		const d = Math.min(c / 2, o * tt(i - e));
...
function Xi(s, t, e, i, n, r) {
	...
	if ((s.beginPath(), r)) {
		...
		s.moveTo(o, a);
		const V = Math.cos(O) * u + o,
			U = Math.sin(O) * u + a;
		s.lineTo(V, U);
		const G = Math.cos(D) * u + o,
			St = Math.sin(D) * u + a;
		s.lineTo(G, St);
	}
	s.closePath();
...
function Sd(s, t, e, i, n) {
	const { fullCircles: r, startAngle: o, circumference: a, options: l } = t,
		{
			borderWidth: c,
			borderJoinStyle: h,
			borderDash: u,
...
var Xe = class extends ft {
	...
	inRange(e, i, n) {
		...
		return (e - o) ** 2 + (i - a) ** 2 < (r.hitRadius + r.radius) ** 2;
	}
	inXRange(e, i) {
...
function sl(s, t) {
	...
	return (
		...
		e.length
			? new zt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i })
			: null
	);
}
function _a(s) {
...
function lr(s, t) {
	const { line: e, target: i, property: n, color: r, scale: o, clip: a } = t,
		l = Jd(e, i, n);
	for (const { source: c, target: h, start: u, end: d } of l) {
		const { style: { backgroundColor: f = r } = {} } = c,
			g = i !== !0;
	...
	Ki = class extends ft {
		...
		_fitCols(t, e, i, n) {
			...
			return (
				this.legendItems.forEach((p, b) => {
					const { itemWidth: y, itemHeight: _ } = xf(i, e, r, p, n);
					b > 0 &&
						f + _ + 2 * a > h &&
						((u += d + a),
		...
		_draw() {
			...
			this.drawTitle(),
				...
				(n.lineWidth = 0.5),
				(n.font = c.string);
			const { boxWidth: g, boxHeight: m, itemHeight: p } = Sa(o, u),
				b = (k, v, M) => {
					if (isNaN(g) || g <= 0 || isNaN(m) || m < 0) return;
					n.save();
					const O = P(M.lineWidth, 1);
					if (
				...
				l.setWidth(this.width),
					_
						...
						: v > 0 &&
							...
							f.line++,
							(L = f.y =
								et(r, this.top + w + h, this.bottom - e[f.line].height)));
				const J = l.x(A);
				if (
					(b(J, L, k),
...
var vf = {
		...
		_element: Ki,
		start(s, t, e) {
			const i = (s.legend = new Ki({ ctx: s.ctx, options: e, chart: s }));
	...
	Us = class extends ft {
		...
		update(t, e) {
			...
			const r = n * X(i.font).lineHeight + this._padding.height;
...
function Sf(s, t) {
	const e = new Us({ ctx: s.ctx, options: t, chart: s });
...
var Mf = {
	...
	Tf = {
		id: "subtitle",
		start(s, t, e) {
			const i = new Us({ ctx: s.ctx, options: e, chart: s });
...
var $s = class extends ft {
	...
	getContext() {
		return (
			this.$context ||
			(this.$context = Ef(this.chart.getContext(), this, this._tooltipItems))
		);
	}
	getTitle(t, e) {
		let { callbacks: i } = e,
	...
	update(t, e) {
		...
		if (!n.length) this.opacity !== 0 && (r = { opacity: 0 });
			...
			const a = zs[i.position].call(this, n, this._eventPosition);
	...
	_updateAnimationTarget(t) {
		const e = this.chart,
			...
			r = i && i.y;
		if (n || r) {
			const o = zs[t.position].call(this, this._active, this._eventPosition);
			if (!o) return;
			const a = (this._size = Ma(this, t)),
...
var Lf = {
		...
		afterDraw(s) {
			...
			if (t && t._willRender()) {
				const e = { tooltip: t };
				if (
					s.notifyPlugins("beforeTooltipDraw", { ...e, cancelable: !0 }) === !1
				)
					return;
...
var Vs = class extends Ce {
	...
	init(t) {
		...
		if (e.length) {
			...
			for (const { index: n, label: r } of e) i[n] === r && i.splice(n, 1);
			this._addedLabels = [];
		}
		super.init(t);
	}
	parse(t, e) {
		...
		return (
			(e =
				isFinite(e) && i[e] === t ? e : Nf(i, t, P(e, t), this._addedLabels)),
			zf(e, i.length - 1)
		);
	}
	determineDataLimits() {
...
function Bf(s, { min: t, max: e }) {
	...
	let i = [],
		n = Ys(t),
		r = Wf(t, e),
		o = r < 0 ? 10 ** Math.abs(r) : 1,
		a = 10 ** r,
		l = n > r ? 10 ** n : 0,
		c = Math.round((t - l) * o) / o,
		h = Math.floor((t - l) / a / 10) * a * 10,
		u = Math.floor((c - h) / 10 ** r),
		d = at(s.min, Math.round((l + h + u * 10 ** r) * o) / o);
	for (; d < e; )
		i.push({ value: d, major: Ia(d), significand: u }),
			u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
			u >= 20 && (r++, (u = 2), (o = r >= 0 ? 1 : o)),
			(d = Math.round((l + h + u * 10 ** r) * o) / o);
	const f = at(s.max, d);
...
function Hf(s, t, e) {
	return (
		(e = B(e) ? e : [e]), { w: Wn(s, t.string, e), h: e.length * t.lineHeight }
	);
}
...
function $f(s) {
	...
	for (let l = 0; l < r; l++) {
		...
		i[l] = d;
		const f = tt(s.getIndexAngle(l) + a),
			g = Math.round(ks(f)),
...
function Yf(s, t) {
	if (!t) return !0;
	const { left: e, top: i, right: n, bottom: r } = s;
	return !(
		Tt({ x: e, y: i }, t) ||
		Tt({ x: e, y: r }, t) ||
		Tt({ x: n, y: i }, t) ||
...
function Jf(s, t, e) {
	const { left: i, top: n, right: r, bottom: o } = e,
		{ backdropColor: a } = t;
	if (!I(a)) {
		const l = jt(t.borderRadius),
...
var Te = class extends Qe {
	...
	setDimensions() {
		const t = (this._padding = st(kr(this.options) / 2)),
	...
	generateTickLabels(t) {
		Qe.prototype.generateTickLabels.call(this, t),
			(this._pointLabels = this.getLabels()
				.map((e, i) => {
					const n = W(this.options.pointLabels.callback, [e, i], this);
					return n || n === 0 ? n : "";
				})
	...
	getPointLabelPosition(t) {
		const { left: e, top: i, right: n, bottom: r } = this._pointLabelItems[t];
...
var De = class extends Ce {
	...
	buildTicks() {
		...
		return (
			...
			(this._majorUnit =
				!i.major.enabled || this._unit === "year" ? void 0 : sg(this._unit)),
			this.initOffsets(n),
			t.reverse && a.reverse(),
...
function fg(s, t = {}) {
	let { base: e, ...i } = t,
		...
		r = Wr.get(n);
	return (
		r === void 0 && ((r = new Intl.RelativeTimeFormat(s, t)), Wr.set(n, r)), r
	);
}
var Gs = null;
function gg() {
...
var $r = class {
		...
		format(t) {
			if (this.inf) {
				...
				const e = this.floor ? Math.floor(t) : eo(t, 3);
				...
				o = (f) =>
					t.isOffsetFixed && t.offset === 0 && f.allowZ
						...
						: t.isValid
							...
							: "",
				a = () =>
					i ? Ng(t) : r({ hour: "numeric", hourCycle: "h12" }, "dayperiod"),
				l = (f, g) =>
					i
						? Vg(t, f)
						: r(g ? { month: f } : { month: f, day: "numeric" }, "month"),
				c = (f, g) =>
					i
						? zg(t, f)
						: r(
...
function si(s, t) {
	const e = s[t] ? he.create(s[t]) : null;
	return [{}, e, t + 1];
}
...
var nt = class s {
		...
		static invalid(t, e = null) {
			...
			const i = t instanceof mt ? t : new mt(t, e);
		...
		mapUnits(t) {
			if (!this.isValid) return this;
			const e = {};
			for (const i of Object.keys(this.values)) e[i] = fc(t(this.values[i], i));
		...
		set(t) {
			if (!this.isValid) return this;
			const e = { ...this.values, ...gn(t, s.normalizeUnit) };
		...
		rescale() {
			if (!this.isValid) return this;
			const t = Tl(this.normalize().shiftToAll().toObject());
		...
		equals(t) {
			...
			for (const i of Ee) if (!e(this.values[i], t.values[i])) return !1;
			return !0;
		}
	},
	es = "Invalid Interval";
...
var os = class s {
		...
		static fromISO(t, e) {
			...
			if (i && n) {
				...
				if (o) {
					const c = nt.fromISO(n, e);
					if (c.isValid) return s.after(r, c);
				} else if (l) {
					const c = nt.fromISO(i, e);
...
function $m(s, t) {
	...
	const e = gt.macroTokenToFormatOpts(s.val),
		i = Ec(e, t);
...
function Ec(s, t) {
	if (!s) return null;
	const i = gt.create(t, s).dtFormatter(Hm()),
		n = i.formatToParts(),
		r = i.resolvedOptions();
...
function Ll(s, t) {
	const e = ae(t.zone, Z.defaultZone);
	...
	if (C(s.year)) n = Z.now();
		...
		for (const l of an) C(s[l]) && (s[l] = Fc[l]);
		const o = lc(s) || cc(s);
...
var Js,
	...
	R = class s {
		constructor(t) {
			...
			if (!i)
				if (t.old && t.old.ts === this.ts && t.old.zone.equals(e))
					...
					const a = ce(t.o) && !t.old ? t.o : e.offset(this.ts);
					(n = nn(this.ts, a)),
		...
		static fromJSDate(t, e = {}) {
			const i = Og(t) ? t.valueOf() : NaN;
			if (Number.isNaN(i)) return s.invalid("invalid input");
			const n = ae(e.zone, Z.defaultZone);
			return n.isValid
		...
		static fromObject(t, e = {}) {
			t = t || {};
			const i = ae(e.zone, Z.defaultZone);
			if (!i.isValid) return s.invalid(Xs(i));
			const n = $.fromObject(e),
				r = gn(t, El),
			...
			const w = m ? Sg(r, o, a) : h ? Mg(r) : lc(r),
				x = w || cc(r);
			if (x) return s.invalid(x);
			const k = m ? bl(r, o, a) : h ? yl(r) : r,
				[v, M] = on(k, c, i),
		...
		set(t) {
			...
			r
				...
				: C(e.ordinal)
					...
					: (u = yl({ ...Or(this.c), ...e }));
			const [d, f] = on(u, this.o, this.zone);
		...
		minus(t) {
			if (!this.isValid) return this;
			const e = nt.fromDurationLike(t).negate();
			return Ie(this, Al(this, e));
		}
		...
		toISO({
			...
			let a = t === "extended",
				l = Ir(this, a, o);
			return (
				an.indexOf(o) >= 3 && (l += "T"), (l += Il(this, a, e, i, n, r, o)), l
			);
		}
	...
	return {
		...
		initChart() {
			...
			if (
				...
				return;
			const i = getComputedStyle(this.$el).fontFamily,
			...
			t ?? (t = {}),
				...
				["doughnut", "pie", "polarArea"].includes(e) &&
					...
					(k = t.plugins.legend.labels).generateLabels ??
						(k.generateLabels = (A) => {
							const L = Pe.overrides[e].plugins.legend.labels.generateLabels(A);
							for (const J of L) J.strokeStyle = _n(J.fillStyle, 0.2);
							return L;
						})),
				e === "polarArea" &&
					((v = t.scales).r ?? (v.r = {}),
		...
		getSurroundingBackgroundColor() {
			...
			for (; i; ) {
				const n = getComputedStyle(i).backgroundColor;
		...
		getChartColors() {
			return {
				backgroundColor: getComputedStyle(this.$refs.backgroundColorElement)
					.color,
