...
var qe = (i) => (i <= 0.0031308 ? i * 12.92 : i ** (1 / 2.4) * 1.055 - 0.055),
	Lt = (i) => (i <= 0.04045 ? i / 12.92 : ((i + 0.055) / 1.055) ** 2.4);
function vo(i, t, e) {
	const s = Lt(et(i.r)),
		n = Lt(et(i.g)),
		o = Lt(et(i.b));
...
function wo(i, t, e) {
	...
	const s = t[i],
		n = e[i];
	S(s) && S(n) ? It(s, n) : Object.hasOwn(t, i) || (t[i] = ve(n));
}
...
var ui = (() =>
	typeof window > "u" ? (i) => i() : window.requestAnimationFrame)();
function fi(i, t) {
	let e = [],
		s = !1;
	return (...n) => {
...
function Ds(i, t, e) {
	...
	if (i._sorted) {
		...
		if (m) {
			...
			if (c) {
				const p = l.slice(g - 1).findIndex((b) => !O(b[r.axis]));
				g += Math.max(0, p);
			}
			o = q(g, n, s) - n;
		} else o = s - n;
...
var xe = (i) => i === 0 || i === 1,
	ns = (i, t, e) => -(2 ** (10 * (i -= 1)) * Math.sin(((i - t) * j) / e)),
	os = (i, t, e) => 2 ** (-10 * i) * Math.sin(((i - t) * j) / e) + 1,
	Rt = {
		linear: (i) => i,
		easeInQuad: (i) => i * i,
		easeOutQuad: (i) => -i * (i - 2),
		...
		easeInExpo: (i) => (i === 0 ? 0 : 2 ** (10 * (i - 1))),
		easeOutExpo: (i) => (i === 1 ? 1 : -(2 ** (-10 * i)) + 1),
		easeInOutExpo: (i) =>
			xe(i)
				? i
				: i < 0.5
...
var Os = {
	...
	logarithmic(i, t, e) {
		if (i === 0) return "0";
		const s = e[t].significand || i / 10 ** Math.floor(st(i));
...
function Vs(i, t, e) {
	if (Object.hasOwn(i, t) || t === "constructor") return i[t];
	const s = e();
	return (i[t] = s), s;
}
function Xo(i, t, e) {
		...
		(_ = t[M % a]),
			!_.skip &&
				...
				b !== D &&
					...
					p !== null &&
						y() &&
						(m.push(cs({ start: p, end: M, loop: u, count: a, style: f })),
						(p = null)),
					(w = M),
					(D = b)));
	return (
		p !== null && m.push(cs({ start: p, end: d, loop: u, count: a, style: f })),
		m
	);
}
function Si(i, t) {
...
function ma(i, t) {
	if (!t) return !1;
	const e = [],
		s = (n, o) => (pi(o) ? (e.includes(o) || e.push(o), e.indexOf(o)) : o);
...
var Oi = (i) => i === "reset" || i === "none",
	...
	Pt = class {
		...
		parsePrimitiveData(t, e, s, n) {
			...
			for (u = 0, f = n; u < f; ++u)
				(m = u + s),
					(d[u] = { [r]: h || o.parse(c[m], m), [l]: a.parse(e[m], m) });
			return d;
		}
		...
		_resolveElementOptions(t, e = "default", s) {
			...
			return (
				g.$shared && ((g.$shared = l), (o[a] = Object.freeze(en(g, l)))), g
			);
		}
...
function Ta(i, t, e, s) {
	...
	if (r && t === r.axis && t !== "r" && a && o.length) {
		const c = r._reversePixels ? ys : ht;
		if (s) {
			if (n._sharedOptions) {
				const h = o[0],
			...
			if (l) {
				...
				h.lo -= Math.max(0, f);
				const m = u.slice(h.hi).findIndex((g) => !O(g[d.axis]));
				h.hi += Math.max(0, m);
			}
			return h;
		}
...
function Wa(i, t, e, s) {
	...
	const r = Math.max(0, t.outerWidth - on(a, i, "left", "right")),
...
function le(i, t, e, s) {
	...
	for (o = 0, a = i.length, c = 0; o < a; ++o) {
		...
		const { same: d, other: u } = Wa(t, e, r, s);
...
function Ka(i, t, e) {
	const s = i.canvas,
		n = new MutationObserver((o) => {
			let a = !1;
			for (const r of o)
				(a = a || Ye(r.addedNodes, s)), (a = a && !Ye(r.removedNodes, s));
			a && e();
		});
...
function qa(i, t, e) {
	const s = i.canvas,
		n = new MutationObserver((o) => {
			let a = !1;
			for (const r of o)
				(a = a || Ye(r.removedNodes, s)), (a = a && !Ye(r.addedNodes, s));
			a && e();
		});
	return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
function tr(i) {
	return !Le() || (typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas)
		? Vi
		: Wi;
}
var mt = class {
...
function fr(i, t, e, s) {
	...
	if (i.isHorizontal()) {
		if (((f = gi(s, o, r)), S(e))) {
			...
			e === "center" ? (m = (c.bottom + c.top) / 2 + g - t) : (m = cn(i, e, t));
		u = r - o;
	} else {
		if (S(e)) {
			const b = Object.keys(e)[0],
			...
			e === "center" ? (f = (c.left + c.right) / 2 - p + t) : (f = cn(i, e, t));
...
var Ot = class i extends mt {
			...
			for (d = 0; d < e; d += l) {
				if (
					...
					for (u = 0, f = m.length; u < f; ++u)
						(x = m[u]),
							!O(x) && !A(x) && ((D = Jt(n, b.data, b.gc, D, x)), (C += _));
		...
		getContext(t) {
			...
			return (
				this.$context || (this.$context = hr(this.chart.getContext(), this))
			);
		}
		_tickSize() {
		...
		_computeGridLineItems(t) {
			...
			const at = P(n.ticks.maxTicksLimit, d),
				I = Math.max(1, Math.ceil(d / at));
			for (D = 0; D < d; D += I) {
				const V = this.getContext(D),
					X = o.setContext(V),
					ue = r.setContext(V),
					fe = X.lineWidth,
					At = X.color,
...
function gr(i, t, e) {
	const s = Et(Object.create(null), [e ? R.get(e) : {}, R.get(t), i.defaults]);
	R.set(t, s),
...
function $i(i, ...t) {
	...
	for (const e of t) {
		const s =
			e.axis || kr(e.position) || (i.length > 1 && fn(i[0].toLowerCase()));
		if (s) return s;
	}
	throw new Error(
...
function Sr(i, t) {
	...
	return (
		Object.keys(s).forEach((a) => {
			...
			const l = $i(a, r, wr(a, i), R.scales[r.type]),
				c = Mr(l, n),
				h = e.scales || {};
...
var re = (i, t, e) => {
	...
	Yi = class {
		...
		createResolver(t, e, s = [""], n) {
			const { resolver: o } = mn(this._resolverCache, t, s);
...
function Cr(i, t) {
	const { isScriptable: e, isIndexable: s } = _i(i);
	for (const n of t) {
		const o = e(n),
			a = s(n),
			r = (a || o) && i[n];
...
function xn(i, t) {
	return (e, s) => (e[i] === s[i] ? e[t] - s[t] : e[i] - s[i]);
}
function _n(i) {
	const t = i.chart,
...
var Ct = class extends mt {
	...
	inRange(e, s, n) {
		...
		return (e - a) ** 2 + (s - r) ** 2 < (o.hitRadius + o.radius) ** 2;
	}
	inXRange(e, s) {
...
function jr(i, t, e) {
	...
	for (const r of s) {
		...
		const d = Si(t, h);
		for (const u of d) {
			const f = Xi(e, o[u.start], o[u.end], u.loop),
				m = wi(r, n, f);
			for (const g of m)
				a.push({
					source: g,
...
function Xi(i, t, e, s) {
	...
	let n = t[i],
		o = e[i];
	return (
		i === "angle" && ((n = N(n)), (o = N(o))), { property: i, start: n, end: o }
	);
}
function $r(i, t) {
...
function qn(i, t) {
	...
	return (
		A(i) ? ((s = !0), (e = i)) : (e = $r(i, t)),
		e.length
			? new G({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
			: null
	);
}
function wn(i) {
...
var Gn = {
	...
	beforeDraw(i, t, e) {
		...
		for (let a = n.length - 1; a >= 0; --a) {
			const r = n[a].$filler;
			r &&
				(r.line.updateControlPoints(o, r.axis), s && r.fill && Ri(i.ctx, r, o));
		}
	},
...
var Nt = class extends Ot {
	...
	parse(t, e) {
		...
		return (
			(e =
				isFinite(e) && s[e] === t ? e : cl(s, t, P(e, t), this._addedLabels)),
			hl(e, s.length - 1)
		);
	}
	determineDataLimits() {
...
function fl(i, { min: t, max: e }) {
	...
	let s = [],
		...
		d = Math.floor((c - h) / 10 ** o),
		u = $(i.min, Math.round((l + h + d * 10 ** o) * a) / a);
	for (; u < e; )
		s.push({ value: u, major: An(u), significand: d }),
			d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
			d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
			(u = Math.round((l + h + d * 10 ** o) * a) / a);
	const f = $(i.max, u);
...
var Ve = class extends Ot {
	...
	parse(t, e) {
		const s = $t.prototype.parse.apply(this, [t, e]);
		if (s === 0) {
			this._zero = !0;
			return;
		}
...
function gl(i, t, e) {
	return (
		(e = A(e) ? e : [e]), { w: As(i, t.string, e), h: e.length * t.lineHeight }
	);
}
...
var Vt = class extends $t {
	...
	setDimensions() {
		const t = (this._padding = Q(Ki(this.options) / 2)),
	...
	generateTickLabels(t) {
		$t.prototype.generateTickLabels.call(this, t),
			(this._pointLabels = this.getLabels()
				.map((e, s) => {
					const n = L(this.options.pointLabels.callback, [e, s], this);
					return n || n === 0 ? n : "";
				})
...
var jt = class extends Ot {
	...
	buildTicks() {
		...
		return (
			...
			(this._majorUnit =
				!s.major.enabled || this._unit === "year" ? void 0 : Cl(this._unit)),
			this.initOffsets(n),
			t.reverse && r.reverse(),
...
function Al({ key: i, labels: t, values: e }) {
	return {
		...
		initChart() {
			...
			const { backgroundColor: s, borderColor: n } = this.getChartColors();
		...
		updateChartTheme() {
			...
			if (!s) return;
			const { backgroundColor: n, borderColor: o } = this.getChartColors();
