...
var Ke = (o, p) => () => {
	try {
		return p || o((p = { exports: {} }).exports, p), p.exports;
	} catch (v) {
		throw ((p = 0), v);
	}
};
	...
	if ((p && typeof p == "object") || typeof p == "function")
		for (const b of Td(p))
			!Ld.call(o, b) &&
				...
				ss(o, b, {
					get: () => p[b],
					enumerable: !(L = Sd(p, b)) || L.enumerable,
				});
	return o;
};
...
`,
		...
		function Ur(e) {
			if (typeof e == "string" && Object.hasOwn(Kt, e)) e = Kt[e];
			else if (e && typeof e.name == "string" && Object.hasOwn(Kt, e.name)) {
				var t = Kt[e.name];
		...
		function $r(e, t) {
			...
			var r = n(e, t);
			if (Object.hasOwn(gr, t.name)) {
				var i = gr[t.name];
				for (var a in i)
					Object.hasOwn(i, a) &&
						(Object.hasOwn(r, a) && (r["_" + a] = r[a]), (r[a] = i[a]));
			}
			if (
				((r.name = t.name),
		...
		var gr = {};
		function Kr(e, t) {
			var n = Object.hasOwn(gr, e) ? gr[e] : (gr[e] = {});
			ge(t, n);
		}
		function Vt(e, t) {
			if (t === !0) return t;
		...
		function fa(e, t, n, r) {
			var i = [e.state.modeGen],
				a = {};
			va(e, t.text, e.doc.mode, n, (m, A) => i.push(m, A), a, r);
			for (
				var l = n.state,
					u = (m) => {
						n.baseTokens = i;
						...
						(n.state = !0),
							va(
								...
								(Y, ie) => {
									for (var ue = B; ee < Y; ) {
										var me = i[B];
										me > Y && i.splice(B, 1, Y, i[B + 1], me),
											(B += 2),
											(ee = Math.min(Y, me));
									}
									if (ie)
										if (A.opaque)
											i.splice(ue, B - ue, Y, "overlay " + ie), (B = ue + 2);
										else
											for (; ue < B; ue += 2) {
												var ve = i[ue + 1];
		...
		function Ca(e, t) {
				...
				$c(a, r, da(e, a, u)),
					a.styleClasses &&
						(a.styleClasses.bgClass &&
							(r.bgClass = _e(a.styleClasses.bgClass, r.bgClass || "")),
			...
			return (
				...
				r.pre.className &&
					(r.textClass = _e(r.pre.className, r.textClass || "")),
				r
			);
		}
		function Rc(e) {
...
`
		...
		function Ka(e, t, n, r) {
			r -= ho(t);
			var i = t.text.length,
				a = De((l) => tr(e, n, l - 1).bottom <= r, i, 0);
			return (i = De((l) => tr(e, n, l).top > r, a, i)), { begin: a, end: i };
		}
		function Ga(e, t, n, r) {
			n || (n = Qr(e, t));
		...
		function _o(e, t, n) {
			...
			if (r.other) {
				var u = n.appendChild(
					y("div", "\xA0", "CodeMirror-cursor CodeMirror-secondarycursor"),
				);
				(u.style.display = ""),
				...
				e.options.readOnly != "nocursor" &&
					(e.state.focused ||
						...
						!e.curOp &&
							...
							g && setTimeout(() => e.display.input.reset(!0), 20)),
		...
		(qr.prototype.update = function (e) {
			...
			(qr.prototype.enableZeroWidthBar = (e, t, n) => {
				e.style.visibility = "";
				function r() {
		...
		var qn = () => {};
		(qn.prototype.update = () => ({ bottom: 0, right: 0 })),
			(qn.prototype.setScrollLeft = () => {}),
			(qn.prototype.setScrollTop = () => {}),
			(qn.prototype.clear = () => {});
		function rn(e, t) {
			t || (t = Dn(e));
		...
		function nl(e) {
			e.display.scrollbars &&
				...
				e.display.scrollbars.addClass &&
					se(e.display.wrapper, e.display.scrollbars.addClass);
		}
		var mf = 0;
		function Fr(e) {
			(e.curOp = {
			...
			for (var f = r.view, m = r.viewFrom, A = 0; A < f.length; A++) {
				...
				if (!B.hidden)
					if (!B.node || B.node.parentNode != a) {
						...
						B.changes &&
							(Se(B.changes, "gutter") > -1 && (Y = !1), Ma(e, B, m, n)),
							Y &&
								(j(B.lineNumber),
								B.lineNumber.appendChild(
									document.createTextNode(pe(e.options, m)),
								)),
		...
		function Ef(e, t, n, r) {
			(this.input = n),
				(this.scrollbarFiller = y("div", null, "CodeMirror-scrollbar-filler")),
				this.scrollbarFiller.setAttribute("cm-not-content", "true"),
				(this.gutterFiller = y("div", null, "CodeMirror-gutter-filler")),
				this.gutterFiller.setAttribute("cm-not-content", "true"),
				(this.lineDiv = G("div", null, "CodeMirror-code")),
				(this.selectionDiv = y(
					"div",
					null,
					null,
				...
				(this.cursorDiv = y("div", null, "CodeMirror-cursors")),
				(this.measure = y("div", null, "CodeMirror-measure")),
				(this.lineMeasure = y("div", null, "CodeMirror-measure")),
				(this.lineSpace = G(
					"div",
					[
						this.measure,
			...
			var a = G("div", [this.lineSpace], "CodeMirror-lines");
			(this.mover = y("div", [a], null, "position: relative")),
				(this.sizer = y("div", [this.mover], "CodeMirror-sizer")),
				...
				(this.gutters = y("div", null, "CodeMirror-gutters")),
				...
				(this.gutterSpecs = Ao(r.gutters, r.lineNumbers)),
				ll(this),
				n.init(this);
		}
		var bi = 0,
		...
		function Yt(e, t, n) {
			var r = e && e.options.selectionsMayTouch,
				i = t[n];
			t.sort((ee, Y) => ye(ee.from(), Y.from())), (n = Se(t, i));
		...
		function Io(e, t) {
			...
			return (
				...
				_r(e, (r) => vl(r, n, t.from.line, t.to.line + 1), !0),
				n
			);
		}
		function gl(e) {
				...
				for (var l = 0; l < a.markedSpans.length; ++l) {
					...
					if (
						...
						if (n) {
							...
							if (
								((r < 0 ? A : m) &&
									(B = Tl(e, B, -r, B && B.line == t.line ? a : null)),
								B &&
									B.line == t.line &&
									(ee = ye(B, n)) &&
									(r < 0 ? ee < 0 : ee > 0))
						...
						var B = It(e, "beforeChange") || (e.cm && It(e.cm, "beforeChange")),
							ee = (ue) => {
								...
								_r(e, (be, Ce) => {
									!Ce &&
										Se(xe, be.history) == -1 &&
										(Dl(be.history, me), xe.push(be.history)),
		...
		function Pf(e, t, n) {
			...
			e.options.lineWrapping ||
				...
				Fo(r, t, n, Za(e)),
				e.options.lineWrapping ||
					(r.iter(f, a.line + t.text.length, (Y) => {
						var ie = li(Y);
						ie > i.maxLineLength &&
							((i.maxLine = Y),
							(i.maxLineLength = ie),
					...
					n &&
						Nt(n, () => {
							(n.curOp.forceUpdate = !0),
								ql(n, r, i),
								ht(n, "lineWidgetChanged", n, this, _(r));
						}));
			}),
			Wt(Rn);
		function ql(e, t, n) {
			...
			(kr.prototype.changed = function () {
				...
				!t ||
					...
					Nt(r, () => {
						...
						if (
							(l &&
								(ja(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
							(r.curOp.updateMaxLine = !0),
							!mr(this.doc, i) && this.height != null)
						) {
							var u = this.height;
							this.height = null;
							var f = Cn(this) - u;
		...
		function sn(e, t, n, r, i) {
			...
			if (
				...
				a.collapsed &&
					e.iter(t.line, n.line + 1, (B) => {
						mr(e, B) && Bt(B, 0);
					}),
				a.clearOnEnter && Ie(a, "beforeCursorEnter", () => a.clear()),
				a.readOnly &&
					(Cc(),
		...
		(Mt.prototype = oe(jn.prototype, {
			...
			clearHistory: function () {
				(this.history = new yi(this.history)),
					_r(this, (t) => (t.history = this.history), !0);
			},
			markClean: function () {
			...
			addLineClass: mt(function (e, t, n) {
				return Pn(this, e, t == "gutter" ? "gutter" : "class", (r) => {
					var i =
						t == "text"
							? "textClass"
							: t == "background"
...
`
		...
		var Nl = 0;
		function Uf(e) {
			if ((Ol(this), !(ot(this, e) || lr(this.display, e)))) {
				kt(e), s && (Nl = +new Date());
				var n = Mr(this, e, !0),
								...
								u = () => {
									++l == i &&
										gt(this, () => {
											...
											an(this.doc, Y),
												_l(this.doc, yr(je(this.doc, n), je(this.doc, xr(Y))));
										})();
								},
								f = (Y, ie) => {
									if (
										this.options.allowDropFileTypes &&
										Se(this.options.allowDropFileTypes, Y.type) == -1
									) {
										u();
										return;
									}
						...
						try {
							...
							if (A) {
								...
								if (
									...
									for (var ee = 0; ee < B.length; ++ee)
										ln(this.doc, "", B[ee].anchor, B[ee].head, "drag");
								this.replaceSelection(A, "around", "paste"),
		...
		function Vf(e, t, n, r) {
			...
			if (
				...
				return Bo(t, n, r);
			var u = (ve, xe) => Po(t, ve instanceof ne ? ve.ch : ve, xe),
				f,
				m = (ve) =>
					e.options.lineWrapping
			...
			if (e.doc.direction == "rtl" || l.level == 1) {
				...
				if (
					ee != null &&
					(B ? ee <= l.to && ee <= A.end : ee >= l.from && ee >= A.begin)
				) {
		...
		var $n = {
			selectAll: Ll,
			singleSelection: (e) =>
				e.setSelection(e.getCursor("anchor"), e.getCursor("head"), ke),
			killLine: (e) =>
				cn(e, (t) => {
					if (t.empty()) {
			...
			delLineLeft: (e) =>
				cn(e, (t) => ({ from: ne(t.from().line, 0), to: t.from() })),
			...
			goDocStart: (e) => e.extendSelection(ne(e.firstLine(), 0)),
			goDocEnd: (e) => e.extendSelection(ne(e.lastLine())),
			goLineStart: (e) =>
				e.extendSelectionsBy((t) => Wl(e, t.head.line), {
					origin: "+move",
					bias: 1,
				}),
			goLineStartSmart: (e) =>
				e.extendSelectionsBy((t) => Ul(e, t.head), {
					origin: "+move",
					bias: 1,
				}),
			goLineEnd: (e) =>
				e.extendSelectionsBy((t) => Jf(e, t.head.line), {
					origin: "+move",
					bias: -1,
				}),
			goLineRight: (e) =>
...
`,
		...
		function rd(e, t, n) {
			return Kn(e, "'" + n + "'", t, (r) => Ci(e, r, !0));
		}
		var Ro = null;
		function Gl(e) {
			if (
				!(e.target && e.target != this.display.input.getField()) &&
				((this.curOp.focus = R(he(this))), !ot(this, e))
			) {
		...
		function Xl(e) {
			if (
				...
				if (!(d && (!e.which || e.which < 10) && Kl(this, e))) {
					var i = String.fromCharCode(r ?? n);
					i != "\b" && (rd(this, e, i) || this.display.input.onKeyPress(e));
				}
			}
		}
		var id = 400,
		...
		function Yl(e) {
			var n = this.display;
			if (!(ot(this, e) || (n.activeTouch && n.input.supportsTouch()))) {
						...
						!(r && ad(this, i, r, a, e)) &&
							(i == 1
								...
								: i == 2
									...
									: i == 3 &&
										(F ? this.display.input.onContextMenu(e) : wo(this)));
				}
			}
		}
		...
		var fn = { toString: () => "CodeMirror.Init" },
			ts = {},
			Ei = {};
		function pd(e) {
			...
			(e.defineOption = n),
				...
				n("specialCharPlaceholder", Rc, (r) => r.refresh(), !0),
				n("electricChars", !0),
				n(
					"inputStyle",
				...
				n("coverGutterNextToScrollbar", !1, (r) => rn(r), !0),
				n(
					"scrollbarStyle",
					"native",
					(r) => {
				...
				n("lineNumberFormatter", (r) => r, In, !0),
		...
		function tt(e, t) {
			...
			(a.wrapper.CodeMirror = this),
				...
				s && h < 11 && setTimeout(() => this.display.input.reset(!0), 20),
				md(this),
				Gf(),
				Fr(this),
				...
				(t.autofocus && !E) || this.hasFocus()
					? setTimeout(() => {
							this.hasFocus() && !this.state.focused && So(this);
						}, 20)
					: en(this);
			for (var l in Ei) Object.hasOwn(Ei, l) && Ei[l](this, t[l], fn);
		...
		function md(e) {
			...
			Ie(t.scroller, "mousedown", gt(e, Yl)),
				s && h < 11
					...
					: Ie(t.scroller, "dblclick", (f) => ot(e, f) || kt(f)),
				Ie(t.scroller, "contextmenu", (f) => Jl(e, f)),
				Ie(t.input.getField(), "contextmenu", (f) => {
			...
			Ie(t.scroller, "touchstart", (f) => {
				...
				Ie(t.scroller, "touchmove", () => {
					t.activeTouch && (t.activeTouch.moved = !0);
				}),
				Ie(t.scroller, "touchend", (f) => {
					var m = t.activeTouch;
					if (
						m &&
						!lr(t, f) &&
				...
				Ie(t.scroller, "scroll", () => {
					t.scroller.clientHeight &&
						(An(e, t.scroller.scrollTop),
						Dr(e, t.scroller.scrollLeft, !0),
						it(e, "scroll", e));
				}),
				Ie(t.scroller, "mousewheel", (f) => ul(e, f)),
				Ie(t.scroller, "DOMMouseScroll", (f) => ul(e, f)),
				Ie(
					t.wrapper,
					"scroll",
		...
		function Xn(e, t, n, r) {
			...
			if (e.options.indentWithTabs)
				for (var Y = Math.floor(A / l); Y; --Y) (ee += l), (B += "	");
		...
		function vd(e) {
			...
			(e.prototype = {
				...
				setOption: function (r, i) {
					...
					(a[r] == i && r != "mode") ||
						((a[r] = i),
						Object.hasOwn(t, r) && gt(this, t[r])(this, i, l),
				...
				execCommand: function (r) {
					if (Object.hasOwn($n, r)) return $n[r].call(null, this);
				},
					...
					this.extendSelectionsBy(
						(l) =>
							this.display.shift || this.doc.extend || l.empty()
								? Go(this.doc, l.head, r, i, this.options.rtlMoveVisually)
								: r < 0
									? l.from()
									: l.to(),
						Re,
				...
				moveV: Tt(function (r, i) {
					...
					if (
						(l.extendSelectionsBy((A) => {
							if (f) return r < 0 ? A.from() : A.to();
							var B = Xt(this, A.head, "div");
							A.goalColumn != null && (B.left = A.goalColumn), u.push(B.left);
							var ee = as(this, B, r, i);
							return (
								i == "page" &&
									A == l.sel.primary() &&
									Lo(this, fi(this, ee, "div").top - B.top),
								ee
							);
						}, Re),
						u.length)
				...
				setSize: Tt(function (r, i) {
					var l = (f) =>
						typeof f == "number" || /^\d+$/.test(String(f)) ? f + "px" : f;
					...
					this.doc.iter(u, this.display.viewTo, (f) => {
						if (f.widgets) {
				...
				(e.registerHelper = (r, i, a) => {
					Object.hasOwn(n, r) || (n[r] = e[r] = { _global: [] }), (n[r][i] = a);
				}),
				(e.registerGlobalHelper = (r, i, a, l) => {
		...
		(Qe.prototype.init = function (e) {
			...
			Ie(i, "paste", (u) => {
				!a(u) ||
					...
					(h <= 11 &&
						setTimeout(
							gt(r, () => this.updateFromDOM()),
							20,
						));
			}),
				Ie(i, "compositionstart", (u) => {
					this.composing = { data: u.data, done: !1 };
				}),
				Ie(i, "compositionupdate", (u) => {
					this.composing || (this.composing = { data: u.data, done: !1 });
				}),
				Ie(i, "compositionend", (u) => {
					this.composing &&
						(u.data != this.composing.data && this.readFromDOMSoon(),
						(this.composing.done = !0));
				}),
				Ie(i, "touchstart", () => n.forceCompositionEnd()),
				Ie(i, "input", () => {
...
`));
			...
			(Qe.prototype.updateFromDOM = function () {
				(this.cm.isReadOnly() || !this.pollContent()) &&
					Nt(this.cm, () => zt(this.cm));
			}),
			(Qe.prototype.setUneditable = (e) => {
			...
			(Qe.prototype.onContextMenu = () => {}),
			(Qe.prototype.resetPosition = () => {}),
		...
		function yd(e, t, n, r, i) {
			...
			function ee(Y) {
				if (Y.nodeType == 1) {
					...
					Y.nodeType == 3 &&
						B(Y.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
			}
					...
					for (
						...
						if (Fe == me || Fe == ve) {
							var $e = _(be < 0 ? e.line : e.rest[be]),
								Ve = Ce[Ne] + xe;
							return (
								(xe < 0 || Fe != me) && (Ve = Ce[Ne + (xe ? 1 : 0)]), ne($e, Ve)
							);
						}
					}
			}
		...
		(st.prototype.init = function (e) {
			...
			e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
				w && (i.style.width = "0px"),
				Ie(i, "input", () => {
					s && h >= 9 && this.hasSelection && (this.hasSelection = null),
						n.poll();
				}),
				Ie(i, "paste", (l) => {
					ot(r, l) ||
...
`)),
			...
			Ie(i, "cut", a),
				...
				Ie(e.lineSpace, "selectstart", (l) => {
					lr(e, l) || kt(l);
				}),
				Ie(i, "compositionstart", () => {
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`);
		...
		function _d(e, t) {
			...
			var u = tt((f) => e.parentNode.insertBefore(f, e.nextSibling), t);
			return u;
		}
		function kd(e) {
			(e.off = _t),
		...
		return (
			...
			(tt.defineMIME = Cr),
			tt.defineMode("null", () => ({ token: (e) => e.skipToEnd() })),
			tt.defineMIME("text/plain", "null"),
			(tt.defineExtension = (e, t) => {
				tt.prototype[e] = t;
			}),
			(tt.defineDocExtension = (e, t) => {
				Mt.prototype[e] = t;
			}),
			(tt.fromTextArea = _d),
			kd(tt),
...
var Yn = Ke((us, cs) => {
	((o) => {
		...
		o.overlayMode = (p, v, L) => ({
			...
			indent: p.indent && ((b, S, s) => p.indent(b.base, S, s)),
			electricChars: p.electricChars,
			innerMode: (b) => ({ state: b.base, mode: p }),
			blankLine: (b) => {
				var S, s;
				return (
...
var ps = Ke((fs, ds) => {
	((o) => {
		...
		var p = /^(\s*)(>[> ]*|[*+-] \[[x ]\]\s|[*+-]\s|(\d+)([.)]))(\s*)/,
			v = /^(\s*)(>[> ]*|[*+-] \[[x ]\]|[*+-]|(\d+)[.)])(\s*)$/,
			L = /[*+-]\s/;
		o.commands.newlineAndIndentContinueMarkdownList = (S) => {
...
var ms = Ke((hs, gs) => {
	((o) => {
		...
		o.defineOption("placeholder", "", (h, g, C) => {
			var k = C && C != o.Init;
			if (g && !k)
				h.on("blur", b),
					h.on("change", S),
				...
				if (h.lineCount() == 1) {
					...
					g =
						C.nodeName == "TEXTAREA"
							? !h.getLine(0).length
							: !/[^\u200b]/.test(
									C.querySelector(".CodeMirror-line").textContent,
								);
				}
				g ? v(h) : p(h);
			}, 20);
...
var ys = Ke((vs, bs) => {
	((o) => {
		...
		o.defineOption("styleSelectedText", !1, (k, c, d) => {
			var x = d && d != o.Init;
			c && !x
...
var ks = Ke((xs, _s) => {
	((o) => {
		...
		function S(w, W, E) {
			W = L(W, "g");
			for (var N = E.line, K = E.ch, J = w.lastLine(); N <= J; N++, K = 0) {
				W.lastIndex = K;
				var re = w.getLine(N),
					q = W.exec(re);
				if (q)
...
`),
					...
					return {
						...
						to: p(
							V + j.length - 1,
							j.length == 1 ? y + j[0].length : j[j.length - 1].length,
						),
						match: D,
					};
				}
		...
		function h(w, W, E) {
			for (var N, K = 0; K <= w.length; ) {
				...
				(!N || re > N.index + N[0].length) && (N = J), (K = J.index + 1);
			}
			return N;
		}
		function g(w, W, E) {
			W = L(W, "g");
			for (var N = E.line, K = E.ch, J = w.firstLine(); N >= J; N--, K = -1) {
				var re = w.getLine(N),
...
`),
		...
		String.prototype.normalize
			? ((k = (w) => w.normalize("NFD").toLowerCase()),
				(c = (w) => w.normalize("NFD")))
			: ((k = (w) => w.toLowerCase()), (c = (w) => w));
		function d(w, W, E, N) {
		...
		function z(w, W, E, N) {
			...
			e: for (
				...
				if (J.length == 1) {
					...
					var V = J[J.length - 1];
					if (Q.slice(0, V.length) != V) continue;
					for (var y = 1, E = re - J.length + 1; y < J.length - 1; y++)
						if (K(w.getLine(E + y)) != J[y]) continue e;
					var G = w.getLine(re + 1 - J.length),
						X = K(G);
					if (X.slice(X.length - J[0].length) != J[0]) continue;
					return {
						from: p(re + 1 - J.length, d(G, X, G.length - J[0].length, K)),
		...
		function M(w, W, E, N) {
			...
			typeof N == "object" ? (K = N.caseFold) : ((K = N), (N = null)),
				typeof W == "string"
					? (K == null && (K = !1),
						(this.matches = (J, re) => (J ? z : x)(w, W, re, K)))
					: ((W = L(W, "gm")),
						!N || N.multiline !== !1
							? (this.matches = (J, re) => (J ? C : s)(w, W, re))
							: (this.matches = (J, re) => (J ? g : S)(w, W, re)));
		}
		(M.prototype = {
			findNext: function () {
				return this.find(!1);
	...
	((o) => {
			...
			return {
				...
				token: (we, Me) => {
					...
					if (
						...
						for (Le.type == "}" && (Le = L(Me)); Le.type == "statement"; )
							Le = L(Me);
					} else
						ce == Le.type
							? L(Me)
				...
				indent: (we, Me) => {
					...
					if (
						...
						for (
							;
							Le.type == "statement" && R.dontIndentStatements.test(Le.info);
						)
							Le = Le.prev;
					if (Oe.indent) {
		...
		function re(O, R) {
			if ((O.backUp(1), O.match(/^(?:R|u8R|uR|UR|LR)/))) {
				...
				return se
					? ((R.cpp11RawStringDelim = se[1]), (R.tokenize = D), D(O, R))
					: !1;
			}
		...
		function Q(O, R) {
			...
			var se = [];
			function _e(T) {
				if (T) for (var he in T) Object.hasOwn(T, he) && se.push(he);
			}
			_e(R.keywords),
				_e(R.types),
				_e(R.builtin),
				_e(R.atoms),
				se.length &&
					((R.helperType = O[0]), o.registerHelper("hintWords", O[0], se));
		...
		Q(["text/x-csrc", "text/x-c", "text/x-chdr"], {
			...
			Q("text/x-java", {
				...
				hooks: {
					"@": (O) =>
						O.match("interface", !1) ? !1 : (O.eatWhile(/[\w$_]/), "meta"),
					'"': (O, R) =>
						O.match(/""$/) ? ((R.tokenize = j), R.tokenize(O, R)) : !1,
				},
				...
				for (var _e; (_e = R.next()); )
					if (_e == "*" && R.eat("/"))
						if (O == 1) {
							se.tokenize = null;
							break;
						} else return (se.tokenize = V(O - 1)), se.tokenize(R, se);
					else if (_e == "/" && R.eat("*"))
		...
		Q("text/x-scala", {
			...
			hooks: {
				...
				"/": (O, R) =>
					O.eat("*") ? ((R.tokenize = V(1)), R.tokenize(O, R)) : !1,
			},
		...
		Q("text/x-kotlin", {
			...
			hooks: {
				"@": (O) => (O.eatWhile(/[\w$_]/), "meta"),
				"*": (O, R) => (R.prevToken == "." ? "variable" : "operator"),
				'"': (O, R) => ((R.tokenize = y(O.match('""'))), R.tokenize(O, R)),
				"/": (O, R) =>
					O.eat("*") ? ((R.tokenize = V(1)), R.tokenize(O, R)) : !1,
				indent: (O, R, se, _e) => {
					...
					if (R.align && R.type == "}")
						return (
							R.indented + (O.context.type == (se || "").charAt(0) ? 0 : _e)
						);
				},
			},
		...
		Q("text/x-ceylon", {
			...
			hooks: {
				...
				"'": (O) => (O.eatWhile(/[\w$_\xa1-\uffff]/), "atom"),
				token: (O, R, se) => {
					if ((se == "variable" || se == "type") && R.prevToken == ".")
						return "variable-2";
				},
			},
	...
	((o) => {
		...
		o.defineMode("cmake", () => {
			...
			return {
				...
				token: (b, S) => (b.eatSpace() ? null : L(b, S)),
			};
		}),
	...
	((o) => {
		...
		o.defineMode("css", (F, D) => {
			...
			return (
				...
				(He.maybeprop = (te, fe, oe) =>
					te == ":" ? Re(oe, fe, "prop") : U(te, fe, oe)),
				(He.prop = (te, fe, oe) => {
					if (te == ";") return Ge(oe);
				...
				(He.pseudo = (te, fe, oe) =>
					te == "meta"
						...
						: te == "word"
							...
							: U(te, fe, oe)),
				(He.documentTypes = (te, fe, oe) =>
					te == "word" && Object.hasOwn(y, fe.current())
		...
		o.defineMIME("text/css", {
			...
			valueKeywords: J,
			tokenHooks: {
				"/": (F, D) => (F.eat("*") ? ((D.tokenize = q), q(F, D)) : !1),
			},
			name: "css",
		}),
	...
	((o) => {
		...
		o.defineMode("xml", (L, b) => {
						...
						? y.eat("[")
							...
							: y.match("--")
								...
								: y.match("DOCTYPE", !0, !0)
									...
									: null
						: y.eat("?")
							? (y.eatWhile(/[\w._-]/), (G.tokenize = z("meta", "?>")), "meta")
			...
			function M(y) {
				return (G, X) => {
					for (var O; (O = G.next()) != null; ) {
						if (O == "<") return (X.tokenize = M(y + 1)), X.tokenize(G, X);
						if (O == ">")
							if (y == 1) {
								X.tokenize = c;
								break;
							} else return (X.tokenize = M(y - 1)), X.tokenize(G, X);
					}
					return "meta";
				};
			}
			...
			function N(y, G) {
				for (var X; ; ) {
					if (
						!y.context ||
						((X = y.context.tagName),
						!Object.hasOwn(s.contextGrabbers, w(X)) ||
							!Object.hasOwn(s.contextGrabbers[w(X)], w(G)))
					)
						return;
					E(y);
				}
			...
			function re(y, G, X) {
				if (y == "word") {
					...
					return (
						X.context &&
							X.context.tagName != O &&
							Object.hasOwn(s.implicitlyClosed, w(X.context.tagName)) &&
							E(X),
			...
			function D(y, G, X) {
				...
				if (y == "endTag" || y == "selfcloseTag") {
					...
					return (
						...
						y == "selfcloseTag" || Object.hasOwn(s.autoSelfClosers, w(O))
							? N(X, O)
			...
			return {
				...
				token: (y, G) => {
					if (
						(!G.tagName && y.sol() && (G.indented = y.indentation()),
						y.eatSpace())
					)
						return null;
					C = null;
					...
					if (R && R[1])
						for (; O; )
							if (O.tagName == R[2]) {
								O = O.prev;
								break;
							} else if (Object.hasOwn(s.implicitlyClosed, w(O.tagName)))
								O = O.prev;
							else break;
					else if (R)
						for (; O; ) {
							var se = s.contextGrabbers[w(O.tagName)];
							if (se && Object.hasOwn(se, w(R[2]))) O = O.prev;
							else break;
						}
				...
				xmlCurrentTag: (y) =>
					y.tagName ? { name: y.tagName, close: y.type == "closeTag" } : null,
				xmlCurrentContext: (y) => {
			...
			Object.hasOwn(o.mimeModes, "text/html") ||
...
var vn = Ke((Is, Ns) => {
	((o) => {
		...
		o.defineMode("javascript", (p, v) => {
			...
			function Q(_, P, ae, pe, ne) {
				...
				for (
					j.state = _,
						...
						j.cc = ye,
						j.style = P,
						Object.hasOwn(_.lexical, "align") || (_.lexical.align = !0);
					;
				) {
			...
			function O(_, P) {
				if (P)
					if (P.block) {
						...
						return G(_, P.vars) ? P : new se(P.prev, new _e(_, P.vars), !1);
				else return null;
			}
			function R(_) {
				return (
			...
			function Z(_) {
				if (_ == "}")
					return (j.marked = "string-2"), (j.state.tokenize = K), y(U);
			}
			function ce(_) {
			...
			function Le(_) {
				return _ != "variable" ? V($) : ((j.marked = "property"), y(Ht));
			}
			function $(_) {
				if (_ == ":") return y(Be);
				if (_ == "(") return V(Ht);
			...
			function H(_, P, ae) {
				...
				return (ne, ye) => (ne == P || ye == P ? y() : V(_, pe));
			}
			function le(_, P, ae) {
			...
			function Pt(_) {
				if (g && _ == ":")
					return j.stream.match(/^\s*\w+\s+is\b/, !1) ? y(Se, Ft, Pe) : y(Pe);
			}
			function Ft(_, P) {
			...
			function it(_) {
				if (_ == "}")
					return (j.marked = "string-2"), (j.state.tokenize = K), y(_t);
			}
			function ot(_, P) {
			...
			function Kt(_, P) {
				...
				if (P == "extends" || P == "implements" || (g && _ == ","))
					return (
						P == "implements" && (j.marked = "keyword"), y(g ? Pe : Se, Kt)
					);
			...
			return {
				...
				token: (_, P) => {
					if (
						(_.sol() &&
							(Object.hasOwn(P.lexical, "align") || (P.lexical.align = !1),
		...
		o.defineMode(
			...
			(C, k) => {
				...
				return {
					...
					token: (W, E) => E.token(W, E),
					indent: (W, E, N) =>
						!W.localMode || /^\s*<\//.test(E)
	...
	((o) => {
		...
		o.defineMode("django:inner", () => {
			...
			return {
				...
				token: (c, d) => d.tokenize(c, d),
				blockCommentStart: "{% comment %}",
				blockCommentEnd: "{% endcomment %}",
			};
		}),
			o.defineMode("django", (p) => {
...
var Di = Ke((Hs, Ws) => {
	((o) => {
		...
		(o.defineSimpleMode = (k, c) => {
			o.defineMode(k, (d) => o.simpleMode(d, c));
		}),
			(o.simpleMode = (k, c) => {
				p(c, "start");
				var d = {},
					...
					z = !1;
				for (var M in c)
					if (M != x && Object.hasOwn(c, M))
						for (var w = (d[M] = []), W = c[M], E = 0; E < W.length; E++) {
							var N = W[E];
							w.push(new b(N, c)), (N.indent || N.dedent) && (z = !0);
						}
				var K = {
					startState: () => ({
						state: "start",
					...
					token: S(d, k),
					innerMode: (re) =>
						re.local && { mode: re.local.mode, state: re.localState },
					indent: C(d, x),
				};
				if (x) for (var J in x) Object.hasOwn(x, J) && (K[J] = x[J]);
				return K;
			});
		function p(k, c) {
			if (!Object.hasOwn(k, c))
			...
			return (d, x) => {
				...
				for (var W = k[x.state], E = 0; E < W.length; E++) {
					...
					if (K) {
						...
						if (
							(J && J.apply && (J = J(K)),
							K.length > 2 && N.token && typeof N.token != "string")
						) {
							...
							return d.backUp(K[0].length - (K[1] ? K[1].length : 0)), J[0];
		...
		function s(k, c) {
			...
			for (var x in k)
				if (Object.hasOwn(k, x)) {
					if (!Object.hasOwn(c, x) || !s(k[x], c[x])) return !1;
					d++;
				}
			for (var x in c) Object.hasOwn(c, x) && d--;
			return d == 0;
		}
		function h(k, c, d, x) {
			var z;
				...
				e: for (;;) {
					for (var W = 0; W < w.length; W++) {
						...
						if (E.data.dedent && E.data.dedentIfLineStart !== !1) {
							...
							if (N && N[0]) {
								M--,
									(E.next || E.push) && (w = k[E.next || E.push]),
				...
				for (var b = 0; b < o.modeInfo.length; b++) {
					...
					if (S.alias) {
						for (var s = 0; s < S.alias.length; s++)
							if (S.alias[s].toLowerCase() == L) return S;
					}
				}
			});
	});
			...
			(p, v) => {
				...
				function re(I, T) {
					...
					var Se =
						...
						Be =
							(T.list === !1 || Ee || ze) && T.indentation <= Oe && I.match(g),
						Ze = null;
					if (
						T.indentationDiff >= 4 &&
						(de || T.prevLine.fencedCodeEnd || T.prevLine.header || ze)
					)
					...
					if (
						...
						if (Be)
							return I.skipToEnd(), (T.hr = !0), (T.thisLine.hr = !0), s.hr;
				...
				function D(I) {
						...
						for (var he = 0; he < I.formatting.length; he++)
							T.push(s.formatting + "-" + I.formatting[he]),
								I.formatting[he] === "header" &&
									T.push(
										s.formatting + "-" + I.formatting[he] + "-" + I.header,
									),
								I.formatting[he] === "quote" &&
									(!v.maxBlockquoteDepth || v.maxBlockquoteDepth >= I.quote
										? T.push(
												s.formatting + "-" + I.formatting[he] + "-" + I.quote,
											)
										: T.push("error"));
					}
					...
					return (
						I.trailingSpaceNewLine
							...
							: I.trailingSpace &&
								T.push("trailing-space-" + (I.trailingSpace % 2 ? "a" : "b")),
				...
				function j(I, T) {
					...
					if (de === "]" && T.imageAltText) {
						...
						var Be = D(T);
						return (
							(T.imageAltText = !1), (T.image = !1), (T.inline = T.f = y), Be
						);
					}
					if (de === "[" && !T.image)
						return (
					...
					if (de === "*" || de === "_") {
						...
						if (
							...
							v.highlightFormatting &&
								(T.formatting =
									He == null ? "strong" : te == null ? "em" : "strong em"),
								He === !0 && (T.em = de),
								te === !0 && (T.strong = de);
							var Se = D(T);
				...
				function X(I) {
					return (T, he) => {
						...
						if (ze === I) {
							(he.f = he.inline = j),
								v.highlightFormatting && (he.formatting = "link-string");
							var de = D(he);
					...
					token: (I, T) => {
						if (((T.formatting = !1), I != T.thisLine.stream)) {
							...
							if (
								...
								if (((T.indentation = he), (T.indentationDiff = null), he > 0))
									return null;
							}
						}
						return T.f(I, T);
				...
				var s = {
						...
						token: (C, k) => {
							...
							if (C.peek() === "`") {
								...
								var d = 1 + C.pos - c;
								return (
									k.code ? d === b && (k.code = !1) : ((b = d), (k.code = !0)),
									null
								);
		...
		o.defineMode("go", (p) => {
			...
			function g(x) {
				return (z, M) => {
					...
					return (E || !(w || x == "`")) && (M.tokenize = h), "string";
				};
			}
			function C(x, z) {
		...
		o.defineMode("jinja2", () => {
			...
			function s(h, g) {
				...
				if (g.intag) {
					...
					if (g.instring)
						return C == g.instring && (g.instring = !1), h.next(), "string";
			...
			return {
				startState: () => ({ tokenize: s, inbrackets: 0, inbraces: 0 }),
				token: (h, g) => {
		...
		o.defineMode(
			...
			(L, b) => {
				...
				function C(c, d, x) {
					if (x.depth == 2)
						return (
							c.match(/^.*?\*\//) ? (x.depth = 1) : c.skipToEnd(), "comment"
						);
					if (c.peek() == "{") {
						...
						if (M && c.match(/^[^>]*>\s*$/, !1)) {
							...
							M.startOfLine
								? (z -= L.indentUnit)
								: x.prev.state.lexical && (z = x.prev.state.lexical.indented);
						} else x.depth == 1 && (z += L.indentUnit);
						return (
							(d.context = new p(o.startState(s, z), s, 0, d.context)), null
						);
					}
					if (x.depth == 1) {
						if (c.peek() == "<")
				...
				function k(c, d, x) {
					...
					if (!z && x.depth != null) {
						...
						M == "{"
							? x.depth++
							: M == "}" && --x.depth == 0 && (d.context = d.context.prev);
					}
					return z;
				}
				return {
					startState: () => ({ context: new p(o.startState(s), s) }),
					copyState: (c) => ({ context: v(c.context) }),
					token: g,
					indent: (c, d, x) => c.context.mode.indent(c.context.state, d, x),
					innerMode: (c) => c.context,
				};
			},
			"xml",
			"javascript",
...
var gu = Ke((pu, hu) => {
	((o) => {
		...
		o.defineMode("nginx", (p) => {
			...
			function d(x) {
				return (z, M) => {
					for (var w = !1, W; (W = z.next()) != null && !(W == x && !w); )
						w = !w && W == "\\";
					return w || (M.tokenize = C), g("string", "string");
				};
			}
			return {
				startState: (x) => ({ tokenize: C, baseIndent: x || 0, stack: [] }),
				token: (x, z) => {
				...
				indent: (x, z) => {
					...
					return (
						/^\}/.test(z) &&
							(M -= x.stack[x.stack.length - 1] == "rule" ? 2 : 1),
						x.baseIndent + M * s
					);
				},
				electricChars: "}",
	...
	((o) => {
		...
		o.defineMode("perl", () => {
					...
					(d.tokenize = (w, W) => {
						for (var E = !1, N, K = 0; (N = w.next()); ) {
							if (N === x[K] && !E)
								return (
									x[++K] !== void 0
										? ((W.chain = x[K]), (W.style = z), (W.tail = M))
										: M && w.eatWhile(M),
									(W.tokenize = k),
									z
								);
			...
			function C(c, d, x) {
				return (
					(d.tokenize = (z, M) => (
						z.string == x && (M.tokenize = k), z.skipToEnd(), "string"
					)),
					d.tokenize(c, d)
				);
			}
		...
		function b(C, k, c, d) {
			...
			if (d !== !1 && C.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
				return (
					...
					C.match(/^->\w/, !1) &&
						(k.tokenize = v([[["->", null]], [[/[\w]+/, "variable"]]], c, d)),
					"variable-2"
				);
			for (
				var x = !1;
		...
		o.defineMode(
			...
			(C, k) => {
				...
				return {
					...
					blockCommentEnd: "*/",
					lineComment: "//",
					innerMode: (z) => ({ state: z.curState, mode: z.curMode }),
				};
			},
			"htmlmixed",
			"clike",
...
var Cu = Ke((Tu, Lu) => {
	((o) => {
		...
		var b = /^[_A-Za-z\xA1-\uFFFF][_A-Za-z0-9\xA1-\uFFFF]*/;
		function S(s) {
			return s.eatSpace()
				? null
				: s.match("//")
		...
		o.defineMode("protobuf", () => ({ token: S, fold: "brace" })),
...
var Mu = Ke((Eu, zu) => {
	((o) => {
		...
		o.registerHelper(
			"hintWords",
			"python",
			L.concat(b).concat(["exec", "print"]),
		);
		function S(h) {
			return h.scopes[h.scopes.length - 1];
		}
		o.defineMode("python", (h, g) => {
			for (
				var C = "error",
				...
				if ((O && (X.indent = G.indentation()), O && S(X).type == "py")) {
					...
					if (G.eatSpace()) {
						...
						return (
							se > R
								? D(X)
								: se < R && j(G, X) && G.peek() != "#" && (X.errorToken = !0),
							null
						);
					} else {
						var _e = re(G, X);
						...
						return (
							ze == "punctuation" &&
								(T.current() == "{"
									? (he.tokenize = se(I + 1))
									: T.current() == "}" &&
										(I > 1 ? (he.tokenize = se(I - 1)) : (he.tokenize = _e))),
							ze
						);
					};
				}
			...
			function D(G) {
				...
				G.scopes.push({
					offset: S(G).offset + h.indentUnit,
					type: "py",
					align: null,
				});
			}
			...
			function j(G, X) {
				for (
					var O = G.indentation();
					X.scopes.length > 1 && S(X).offset > O;
				) {
			...
			var y = {
				...
				token: (G, X) => {
					...
					return (
						R &&
							R != "comment" &&
							(X.lastToken =
								R == "keyword" || R == "punctuation" ? G.current() : R),
				...
				indent: (G, X) => {
					if (G.tokenize != J) return G.tokenize.isString ? o.Pass : 0;
					var O = S(G),
						R =
							O.type == X.charAt(0) ||
							(O.type == "py" &&
	...
	((o) => {
		...
		o.defineMode("ruby", (g) => {
			...
			function c(E, N) {
				...
				if (K == "/") return d(E) ? k(M(K, "string-2", !0), E, N) : "operator";
				if (K == "%") {
					var re = "string",
						q = !0;
					E.eat("s")
			...
			function d(E) {
				for (var N = E.pos, K = 0, J, re = !1, q = !1; (J = E.next()) != null; )
					if (q) q = !1;
					else {
						if ("[{(".indexOf(J) > -1) K++;
						else if ("]})".indexOf(J) > -1) {
				...
				return (
					...
					(N, K) => {
						if (N.peek() == "}") {
							...
							N.peek() == "{" && (K.tokenize[K.tokenize.length - 1] = x(E + 1));
						return c(N, K);
					}
				);
			}
		...
		o.defineMode(
			...
			(p) => {
				...
				function J(q, F) {
					var D = q.peek();
					if (q.match("/*"))
						return (F.tokenizer = w(q.indentation(), !0)), F.tokenizer(q, F);
					if (q.match("//"))
						return (F.tokenizer = w(q.indentation(), !1)), F.tokenizer(q, F);
					if (q.match("#{")) return (F.tokenizer = E(J)), "operator";
					if (D === '"' || D === "'")
					...
					if (F.cursorHalf) {
						...
						if (q.match(C)) return z(q) && (F.cursorHalf = 0), "keyword";
						if (q.match(/^url/) && q.peek() === "(")
							return (F.tokenizer = M), z(q) && (F.cursorHalf = 0), "atom";
						if (D === "$")
							return (
								q.next(),
								q.eatWhile(/[\w-]/),
						...
						if (q.match(c)) return z(q) && (F.cursorHalf = 0), "operator";
						if (q.eatWhile(/[\w-]/))
							return (
								z(q) && (F.cursorHalf = 0),
	...
	((o) => {
		...
		o.defineMode("shell", () => {
			...
			function s(d, x) {
				...
				if (M === "'" || M === '"' || M === "`")
					return (
						x.tokens.unshift(h(M, M === "`" ? "quote" : "string")), c(d, x)
					);
				if (M === "#")
					return z && d.eat("!")
						? (d.skipToEnd(), "meta")
			...
			function g(d, x) {
				return (z, M) => ((M.tokens[0] = h(d, x)), z.next(), c(z, M));
			}
			var C = (d, x) => {
				...
				return /['"({]/.test(z)
					? ((x.tokens[0] = h(
						...
						c(d, x))
					: (/\d/.test(z) || d.eatWhile(/\w/), x.tokens.shift(), "def");
			};
			function k(d) {
				return (x, z) => (
...
var Uu = Ke((Hu, Wu) => {
	((o) => {
		...
		o.defineMode("sql", (g, C) => {
			...
			function J(Q, j) {
				...
				if (
					...
					return (
						(j.tokenize = (X, O) => (O.tokenize = re(X.next(), !0))(X, O)),
						"keyword"
					);
			...
			return {
				startState: () => ({ tokenize: J, context: null }),
				token: (Q, j) => {
					if (
						(Q.sol() &&
							j.context &&
		...
		function p(g) {
			for (var C; (C = g.next()) != null; )
				if (C == "`" && !g.eat("`")) return "variable-2";
			return (
	...
	((o) => {
		...
		o.defineMode("stylus", (E) => {
			...
			return (
				...
				(he.vendorPrefixes = ($, H, le) =>
					$ == "word" ? ((ge = "property"), ke(le, H, "block", 0)) : Je(le)),
				(he.pseudo = ($, H, le) =>
					Z(Le(H.string))
						? Ge($, H, le)
						: (H.match(/^[a-z-]+/),
				...
				(he.atBlock_parens = ($, H, le) => {
					if ($ == "{" || $ == "}") return le.context.type;
					if ($ == ")")
						return Me(H) ? ke(le, H, "block") : ke(le, H, "atBlock");
					if ($ == "word") {
						var De = H.current().toLowerCase();
						return (
							(ge = te(De)),
						...
						: $ == "{"
							...
							: $ == "}"
								...
								: $ == "unit" && /^[0-9]+%$/.test(H.current())
									? ke(le, H, "keyframes")
									: $ == "word" &&
											((ge = te(H.current())), ge == "block-keyword")
				...
				(he.interpolation = ($, H, le) => (
					...
					$ == "}"
						...
						: $ == "variable-name"
							? ke(le, H, "variableName", 0)
							: ($ == "word" &&
									((ge = te(H.current())), ge == "tag" && (ge = "atom")),
								le.context.type)
				)),
				(he.extend = ($, H, le) =>
					$ == "[" || $ == "="
						...
						: $ == "]"
							...
							: $ == "word"
								...
								: Je(le)),
				(he.variableName = ($, H, le) =>
					$ == "string" || $ == "[" || $ == "]" || H.current().match(/^(\.|\$)/)
						? (H.current().match(/^\.[\w-]+/i) && (ge = "variable-2"),
							"variableName")
						: Ge($, H, le)),
				{
					startState: ($) => ({
...
var Xu = Ke((Gu, Zu) => {
	((o) => {
		...
		function w(q, F, D) {
			...
			if (q.match(d)) {
				var y = q.current();
				return Object.hasOwn(S, y)
					? "variable-2"
					: Object.hasOwn(b, y)
						? "atom"
						: Object.hasOwn(v, y)
							? (Object.hasOwn(L, y) && (F.prev = "define"), "keyword")
							: D == "define"
								? "def"
								: "variable";
			}
	...
	((o) => {
		...
		o.defineMode("coffeescript", (p, v) => {
			...
			function W(F, D) {
				...
				if (F.match(x))
					return (D.tokenize = E(F.current(), !1, "string")), D.tokenize(F, D);
				if (F.match(z)) {
					if (F.current() != "/" || F.match(/^.*\//, !1))
						return (
							(D.tokenize = E(F.current(), !0, "string-2")), D.tokenize(F, D)
						);
					F.backUp(1);
				}
			...
			function E(F, D, Q) {
				return (j, V) => {
					...
					return (
						D && (v.singleLineStringErrors ? (Q = L) : (V.tokenize = W)), Q
					);
				};
			}
			function N(F, D) {
		...
		o.defineMode(
			...
			(p) => {
				...
				function w(U, Z) {
					if (U.match(/^when\b/))
						return (
							(Z.javaScriptLine = !0), (Z.javaScriptLineExcludesColon = !0), v
						);
				}
				function W(U) {
				...
				function Oe(U, Z) {
					...
					if (U.match(/^(<[^\n]*)/, !1))
						return (
							Be(U, Z, "htmlmixed"), (Z.innerModeForLine = !0), Ze(U, Z, !0)
						);
				}
				function qe(U, Z) {
					if (U.eat(".")) {
...
var cc = Ke((sc, uc) => {
	((o) => {
		...
		o.defineMode("vue-template", (v, L) => {
			...
			o.defineMode(
				"vue",
				(v) => o.getMode(v, { name: "htmlmixed", tags: p }),
				"htmlmixed",
				"xml",
				"javascript",
				"coffeescript",
		...
		o.defineMode("yaml", () => {
			...
			return {
				token: (L, b) => {
					...
					if (
						((b.escaped = !1),
						S == "#" && (L.pos == 0 || /\s/.test(L.string.charAt(L.pos - 1))))
					)
						return L.skipToEnd(), "comment";
					if (L.match(/^('([^']|\\.)*'?|"([^"]|\\.)*"?)/)) return "string";
					if (b.literal && L.indentation() > b.keyCol)
						return L.skipToEnd(), "string";
...
function qi(o, p, v, L, b, S) {
	...
	if (o.attributes)
		for (var h in o.attributes)
			Object.hasOwn(o.attributes, h) && s.setAttribute(h, o.attributes[h]);
	(s.className = o.name),
...
function Br(o) {
	...
	if (
		...
		var S = o.hasExplicitMinHeight ? "max-height" : "height";
		p.getOption("fullScreen")
			? (p.getScrollerElement().style.removeProperty(S),
				L.style.removeProperty(S))
			: (p.getScrollerElement().style.setProperty(S, o.options.maxHeight),
...
function Pi(o) {
	...
	function v(y) {
		...
		return (
			y.styles &&
			y.styles[2] &&
			y.styles[2].indexOf("formatting-code-block") !== -1
		);
	}
	function L(y) {
...
function bn(o) {
	...
	if (
		(p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = k), S)
	) {
		var c = o.options.previewRender(o.value(), L);
		c != null && (L.innerHTML = c),
	...
	S.classList.contains("editor-preview-active")
		? (S.classList.remove("editor-preview-active"),
			b &&
				...
				L.classList.remove("disabled-for-preview")))
		: (setTimeout(() => {
				S.classList.add("editor-preview-active");
			}, 1),
			b &&
				(b.classList.add("active"), L.classList.add("disabled-for-preview")));
...
function Lr(o, p, v) {
	if (
		...
		for (
			var L = o.getCursor("start"), b = o.getCursor("end"), S = L.line;
			S <= b.line;
			S++
		)
			((s) => {
...
function Pd(o) {
	if (
		...
		for (
			var p = o.getCursor("start"), v = o.getCursor("end"), L, b = p.line;
			b <= v.line;
			b++
		)
			(L = o.getLine(b)),
...
function gc(o) {
	...
	for (var b = 0; b < v.length; b++)
		v[b].charCodeAt(0) >= 19968 ? (L += v[b].length) : (L += 1);
	return L;
}
function Te(o) {
	(o = o || {}), (this.hasExplicitMinHeight = !!o.minHeight), (o.parent = this);
	var p = !0;
	if (
		...
		for (var v = document.styleSheets, L = 0; L < v.length; L++)
			v[L].href &&
				v[L].href.indexOf("//maxcdn.bootstrapcdn.com/font-awesome/") > -1 &&
				(p = !1);
	if (p) {
	...
	if (
		(Object.hasOwn(o, "previewClass") || (o.previewClass = "editor-preview"),
		Object.hasOwn(o, "status") ||
		...
		typeof o.maxHeight < "u" && !this.hasExplicitMinHeight
		...
		this.codemirror.on("dragenter", (h, g) => {
			this.updateStatusBar(
				"upload-image",
				this.options.imageTexts.sbOnDragEnter,
			),
				g.stopPropagation(),
				g.preventDefault();
		}),
			this.codemirror.on("dragend", (h, g) => {
				this.updateStatusBar("upload-image", this.options.imageTexts.sbInit),
					g.stopPropagation(),
					g.preventDefault();
			}),
			this.codemirror.on("dragleave", (h, g) => {
				this.updateStatusBar("upload-image", this.options.imageTexts.sbInit),
					g.stopPropagation(),
					g.preventDefault();
			}),
			this.codemirror.on("dragover", (h, g) => {
				this.updateStatusBar(
					"upload-image",
					this.options.imageTexts.sbOnDragEnter,
				),
			...
			this.codemirror.on("drop", (h, g) => {
				g.stopPropagation(),
					g.preventDefault(),
					o.imageUploadFunction
						? this.uploadImagesUsingCustomFunction(
								o.imageUploadFunction,
								g.dataTransfer.files,
							)
						: this.uploadImages(g.dataTransfer.files);
			}),
			this.codemirror.on("paste", (h, g) => {
				o.imageUploadFunction
					? this.uploadImagesUsingCustomFunction(
							o.imageUploadFunction,
							g.clipboardData.files,
						)
					: this.uploadImages(g.clipboardData.files);
			});
	}
}
function kc() {
...
Maximum file size is #image_max_size#.`,
		...
		Te.prototype.render = function (o) {
			...
			var p = this.options,
				L = {};
			function b(E) {
				const N = E.getInputField(),
					K = N.form;
				if (K) {
					const J = Array.from(K.elements).filter(
							(q) =>
								!(
			...
			(L.Enter = "newlineAndIndentContinueMarkdownList"),
				...
				(L.Esc = (E) => {
					E.getOption("fullScreen") && Br(this);
				}),
			...
			var h, g;
			p.overlayMode
				? (CodeMirror.defineMode("overlay-mode", (E) =>
					...
					this.codemirror.on("change", () => {
						clearTimeout(this._autosave_timeout),
							(this._autosave_timeout = setTimeout(
								...
								this.options.autosave.submit_delay ||
			...
			function w() {
				p.previewImagesInEditor &&
					c.querySelectorAll(".cm-image-marker").forEach((E) => {
		...
		Te.prototype.uploadImage = function (o, p, v) {
			...
			(h.upload.onprogress = (g) => {
				if (g.lengthComputable) {
					...
					L.updateStatusBar(
						"upload-image",
						L.options.imageTexts.sbProgress
		...
		Te.prototype.createToolbar = function (o) {
			if (((o = o || this.options.toolbar), !(!o || o.length === 0))) {
				...
				var b = {};
				for (this.toolbar = o, p = 0; p < o.length; p++)
					if (
						!(o[p].name == "guide" && this.options.toolbarGuideIcon === !1) &&
						!(
							this.options.hideIcons &&
							this.options.hideIcons.indexOf(o[p].name) != -1
						) &&
						!(
						...
						if (o[p] === "|") {
							for (var S = !1, s = p + 1; s < o.length; s++)
								o[s] !== "|" &&
									(!this.options.hideIcons ||
										this.options.hideIcons.indexOf(o[s].name) == -1) &&
									(S = !0);
							if (!S) continue;
						}
						((C) => {
							...
							if (
								...
								(c.className = "imageInput"),
									...
									(c.multiple = !0),
									(c.name = "image"),
									(c.accept = this.options.imageAccept),
				...
				(this.toolbar_div = v), (this.toolbarElements = b);
...
pc();
wc();
CodeMirror.commands.tabAndIndentMarkdownList = (o) => {
...
CodeMirror.commands.shiftTabAndUnindentMarkdownList = (o) => {
	var p = o.listSelections(),
		v = p[0].head,
		L = o.getStateAfter(v.line),
		b = L.list !== !1;
	...
	return {
		...
		async init() {
			if (
				...
				const z = this.editor.codemirror.getInputField();
				z && z.setAttribute("aria-label", L);
			}
					...
					try {
						...
						if (w.origin === "+input") {
							...
							if (E.endsWith(W) && E !== "[]" + W) {
								...
								setTimeout(() => {
									z.setSelection(
										{ line: K.line, ch: re + E.lastIndexOf("(") + 1 },
										{ line: K.line, ch: re + E.lastIndexOf(")") },
									);
								}, 25);
							}
						}
		...
		handleEditorVisibilityChange() {
			const x = this.isEditorVisible();
			x && !this.wasEditorVisible && this.editor?.codemirror?.refresh(),
