				...
				d = (e || "YYYY-MM-DDTHH:mm:ssZ").replace(
					...
					(u) => {
						switch (u) {
							...
							case "Do":
								return s.ordinal(this.$D);
							case "gggg":
								return this.weekYear();
							case "GGGG":
								return this.isoWeekYear();
							case "wo":
								return s.ordinal(this.week(), "W");
							case "w":
							case "ww":
								return _.s(this.week(), u === "w" ? 1 : 2, "0");
							case "W":
							case "WW":
								return _.s(this.isoWeek(), u === "W" ? 1 : 2, "0");
							case "k":
							case "kk":
								return _.s(
			...
			l = {
				...
				MMM: [
					...
					function (c) {
						var y = o("months"),
							v =
								(o("monthsShort") || y.map((L) => L.slice(0, 3))).indexOf(c) +
								1;
...
var Pn = D(($e, Ce) => {
	((n, t) => {
		...
		var i = t.prototype,
			e = (u) => u && (u.indexOf ? u : u.s),
			r = (u, o, f, l, m) => {
				var c = u.name ? u : u.$locale(),
					y = e(c[o]),
					v = e(c[f]),
					L = y || v.map((b) => b.slice(0, l));
				if (!m) return L;
				var w = c.weekStart;
				return L.map((b, C) => L[(C + (w || 0)) % 7]);
			},
			s = () => a.Ls[a.locale()],
			_ = (u, o) =>
				u.formats[o] ||
			...
			d = function () {
				return {
					months: (o) => (o ? o.format("MMMM") : r(this, "months")),
					monthsShort: (o) =>
						o ? o.format("MMM") : r(this, "monthsShort", "months", 3),
					firstDayOfWeek: () => this.$locale().weekStart || 0,
					weekdays: (o) => (o ? o.format("dddd") : r(this, "weekdays")),
					weekdaysMin: (o) =>
						o ? o.format("dd") : r(this, "weekdaysMin", "weekdays", 2),
					weekdaysShort: (o) =>
						o ? o.format("ddd") : r(this, "weekdaysShort", "weekdays", 3),
					longDateFormat: (o) => _(this.$locale(), o),
		...
		(i.localeData = function () {
			...
			(a.localeData = () => {
				var u = s();
				return {
					firstDayOfWeek: () => u.weekStart || 0,
					weekdays: () => a.weekdays(),
					weekdaysShort: () => a.weekdaysShort(),
					weekdaysMin: () => a.weekdaysMin(),
					months: () => a.months(),
					monthsShort: () => a.monthsShort(),
					longDateFormat: (o) => _(u, o),
					meridiem: u.meridiem,
					ordinal: u.ordinal,
				};
			}),
			(a.months = () => r(s(), "months")),
			(a.monthsShort = () => r(s(), "monthsShort", "months", 3)),
			(a.weekdays = (u) => r(s(), "weekdays", null, null, u)),
			(a.weekdaysShort = (u) => r(s(), "weekdaysShort", "weekdays", 3, u)),
			(a.weekdaysMin = (u) => r(s(), "weekdaysMin", "weekdays", 2, u));
	});
});
var Vn = D((Oe, ze) => {
	((n, t) => {
		...
		return (a, i, e) => {
			...
			(d.startOf = function (o, f) {
				...
				(e.tz.guess = () => Intl.DateTimeFormat().resolvedOptions().timeZone),
				(e.tz.setDefault = (o) => {
					r = o;
				});
		};
	...
	((n, t) => {
		...
		var n = 1e3,
			...
			w = {
				...
				a: (g) => (g < 0 ? Math.ceil(g) || 0 : Math.floor(g)),
				p: (g) =>
					({ M: u, y: f, w: d, d: _, D: l, h: s, m: r, s: e, ms: i, Q: o })[
						g
					] ||
					String(g || "")
						.toLowerCase()
		...
		(H.l = x),
			(H.i = I),
			(H.w = (g, M) =>
				$(g, { locale: M.$L, utc: M.$u, x: M.$x, $offset: M.$offset }));
		var U = (() => {
				function g(h) {
				...
				return (
					...
					(M.startOf = function (h, p) {
						var S = !!H.u(p) || p,
							...
							T = (R, J) => {
								var G = H.w(
									this.$u ? Date.UTC(this.$y, J, R) : new Date(this.$y, J, R),
									this,
								);
					...
					(M.add = function (h, p) {
						...
						var j = H.p(p),
							T = (F) => {
								var P = $(this);
								return H.w(P.date(P.date() + Math.round(F * h)), this);
							};
					...
					(M.format = function (h) {
						...
						var S = h || "YYYY-MM-DDTHH:mm:ssZ",
							...
							B = Y.meridiem,
							Q = (J, G, X, ee) =>
								(J && (J[G] || J(this, S))) || X[G].slice(0, ee),
							ae = (J) => H.s(T % 12 || 12, J, "0"),
							R =
								B ||
								((J, G, X) => {
									var ee = J < 12 ? "AM" : "PM";
								...
								((X) => {
									switch (X) {
										...
										case "D":
											return this.$D;
										case "DD":
											return H.s(this.$D, 2, "0");
										case "d":
											return String(this.$W);
										case "dd":
											return Q(Y.weekdaysMin, this.$W, F, 2);
										case "ddd":
											return Q(Y.weekdaysShort, this.$W, F, 3);
										case "dddd":
											return F[this.$W];
										case "H":
											return String(T);
										...
										case "ss":
											return H.s(this.$s, 2, "0");
										case "SSS":
											return H.s(this.$ms, 3, "0");
										case "Z":
											return j;
									}
									return null;
	...
	((n, t) => {
		typeof Ne == "object" && typeof Fe < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_am =
						t(n.dayjs));
	})(Ne, (n) => {
		function t(e) {
	...
	((n, t) => {
		...
		var a = t(n),
			...
			o = {
				...
				preparse: (f) => f.replace(s, (l) => r[l]).replace(_, ","),
				postformat: (f) => f.replace(d, (l) => e[l]).replace(u, "\u060C"),
				ordinal: (f) => f,
				formats: {
					LT: "HH:mm",
					LTS: "HH:mm:ss",
	...
	((n, t) => {
		...
		var i = a(t),
			...
			_ = {
				...
				preparse: (d) =>
					d.replace(/[١٢٣٤٥٦٧٨٩٠]/g, (u) => r[u]).replace(/،/g, ","),
				postformat: (d) =>
					d.replace(/\d/g, (u) => e[u]).replace(/,/g, "\u060C"),
				ordinal: (d) => d,
				formats: {
					LT: "HH:mm",
					LTS: "HH:mm:ss",
	...
	((n, t) => {
		typeof Mt == "object" && typeof Yt < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_he =
						t(n.dayjs));
	})(Mt, (n) => {
		function t(s) {
			return s && typeof s == "object" && "default" in s ? s : { default: s };
		...
		var a = t(n),
			i = {
				...
				relativeTime: {
					future: "%s m\xFAlva",
					past: "%s",
					s: (e, r, s, _) => "n\xE9h\xE1ny m\xE1sodperc" + (_ || r ? "" : "e"),
					m: (e, r, s, _) => "egy perc" + (_ || r ? "" : "e"),
					mm: (e, r, s, _) => e + " perc" + (_ || r ? "" : "e"),
					h: (e, r, s, _) => "egy " + (_ || r ? "\xF3ra" : "\xF3r\xE1ja"),
					hh: (e, r, s, _) => e + " " + (_ || r ? "\xF3ra" : "\xF3r\xE1ja"),
					d: (e, r, s, _) => "egy " + (_ || r ? "nap" : "napja"),
					dd: (e, r, s, _) => e + " " + (_ || r ? "nap" : "napja"),
					M: (e, r, s, _) => "egy " + (_ || r ? "h\xF3nap" : "h\xF3napja"),
					MM: (e, r, s, _) => e + " " + (_ || r ? "h\xF3nap" : "h\xF3napja"),
					y: (e, r, s, _) => "egy " + (_ || r ? "\xE9v" : "\xE9ve"),
					yy: (e, r, s, _) => e + " " + (_ || r ? "\xE9v" : "\xE9ve"),
				},
				formats: {
					LT: "H:mm",
					LTS: "H:mm:ss",
	...
	((n, t) => {
		typeof zt == "object" && typeof At < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_ko =
						t(n.dayjs));
	})(zt, (n) => {
		function t(e) {
			return e && typeof e == "object" && "default" in e ? e : { default: e };
...
var Li = D((qt, It) => {
	((n, t) => {
		...
		var a = t(n),
			...
			s = (d, u) => (r.test(u) ? i[d.month()] : e[d.month()]);
		(s.s = e), (s.f = i);
		var _ = {
			name: "lt",
			weekdays:
...
var ki = D((Rt, Zt) => {
	((n, t) => {
		...
		var r =
			...
			_ = /D MMMM/,
			d = (o, f) => (_.test(f) ? r[o.month()] : s[o.month()]);
		(d.s = s), (d.f = r);
		var u = {
			name: "pl",
			weekdays:
...
var wi = D((nn, rn) => {
	((n, t) => {
		...
		var u = (l, m) => (_.test(m) ? i[l.month()] : e[l.month()]);
		(u.s = e), (u.f = i);
		var o = (l, m) => (_.test(m) ? r[l.month()] : s[l.month()]);
		(o.s = s), (o.f = r);
		var f = {
			name: "ru",
			weekdays:
	...
	((n, t) => {
		typeof an == "object" && typeof sn < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_sl =
						t(n.dayjs));
	})(an, (n) => {
		function t(_) {
	...
	((n, t) => {
		...
		var a = t(n),
			i = {
				...
				correctGrammarCase: (r, s) =>
					r % 10 >= 1 && r % 10 <= 4 && (r % 100 < 10 || r % 100 >= 20)
						? r % 10 == 1
							? s[0]
							: s[1]
						: s[2],
				relativeTimeFormatter: (r, s, _, d) => {
					var u = i.words[_];
					if (_.length === 1)
						return _ === "y" && s
							? "\u0458\u0435\u0434\u043D\u0430 \u0433\u043E\u0434\u0438\u043D\u0430"
	...
	((n, t) => {
		typeof on == "object" && typeof _n < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_sr =
						t(n.dayjs));
	})(on, (n) => {
		function t(r) {
			return r && typeof r == "object" && "default" in r ? r : { default: r };
...
var Ii = D((Yn, yn) => {
	((n, t) => {
		...
		var _ = (u, o) => (r.test(o) ? i[u.month()] : e[u.month()]);
		(_.s = e), (_.f = i);
		var d = {
			name: "uk",
			weekdays:
	...
	((n, t) => {
		typeof pn == "object" && typeof Ln < "u"
			...
			: typeof define == "function" && define.amd
				? define(["dayjs"], t)
				: ((n =
						typeof globalThis < "u" ? globalThis : n || self).dayjs_locale_ur =
						t(n.dayjs));
	})(pn, (n) => {
		function t(e) {
			return e && typeof e == "object" && "default" in e ? e : { default: e };
...
var Se = (t, a, i) => {
	...
	rr = (t) => (t < 0 ? Math.ceil(t) || 0 : Math.floor(t)),
	ar = (t) => {
		var a = {
			M: V,
			y: K,
...
var En = "$isDayjsObject",
	...
	ur = (t, a) => E(t, { locale: a.$L, utc: a.$u, x: a.$x, $offset: a.$offset }),
	z = Fn;
z.l = Me;
z.i = ke;
z.w = ur;
var dr = (t) => {
		...
		if (typeof a == "string" && !/Z$/i.test(a)) {
			...
			if (e) {
				...
				return i
					? new Date(
							Date.UTC(e[1], r, e[3] || 1, e[4] || 0, e[5] || 0, e[6] || 0, s),
						)
		...
		return (
			...
			(t.startOf = function (i, e) {
				var s = z.u(e) ? !0 : e,
					...
					d = (L, w) => {
						var b = z.w(
							this.$u ? Date.UTC(this.$y, w, L) : new Date(this.$y, w, L),
							this,
						);
					...
					u = (L, w) => {
						var b = [0, 0, 0, 0],
							C = [23, 59, 59, 999];
						return z.w(
							this.toDate()[L].apply(this.toDate("s"), (s ? b : C).slice(w)),
							this,
						);
					},
					o = this.$W,
			...
			(t.add = function (i, e) {
				...
				var _ = z.p(e),
					d = (l) => {
						var m = E(this);
						return z.w(m.date(m.date() + Math.round(l * i)), this);
					};
			...
			(t.format = function (i) {
				...
				var s = i || An,
					...
					l = r.months,
					m = r.meridiem,
					c = (b, C, A, I) => (b && (b[C] || b(this, s))) || A[C].slice(0, I),
					y = (b) => z.s(d % 12 || 12, b, "0"),
					v =
						m ||
						((w, b, C) => {
					...
					L = (b) => {
						switch (b) {
							...
							case "D":
								return this.$D;
							case "DD":
								return z.s(this.$D, 2, "0");
							case "d":
								return String(this.$W);
							case "dd":
								return c(r.weekdaysMin, this.$W, f, 2);
							case "ddd":
								return c(r.weekdaysShort, this.$W, f, 3);
							case "dddd":
								return f[this.$W];
							case "H":
								return String(d);
							...
							case "s":
								return String(this.$s);
							case "ss":
								return z.s(this.$s, 2, "0");
							case "SSS":
								return z.s(this.$ms, 3, "0");
							case "Z":
								return _;
							default:
								break;
				...
				return s.replace(In, (w, b) => b || L(w) || _.replace(":", ""));
			}),
...
E.extend = (n, t) => (n.$i || (n(t, Ye, E), (n.$i = !0)), E);
E.locale = Me;
E.isDayjs = ke;
E.unix = (n) => E(n * 1e3);
E.en = ue[le];
