            ...
            <form onSubmit={submit} className="mt-4 space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="grind_size" className="block text-[12.5px] font-semibold text-espresso">
                            Ukuran gilingan
                        </label>
                        <select
                            id="grind_size"
                        ...
                        {errors.grind_size && <p className="text-[12px] font-medium text-error" role="alert">{errors.grind_size}</p>}
                    </div>
                    <div className="space-y-1.5">
                        <label htmlFor="water_temp" className="block text-[12.5px] font-semibold text-espresso">
                            Suhu air
                        </label>
                        <div className="relative">
                            <input
                                ...
                                placeholder="91"
                                className={cn('input-field pr-10', errors.water_temp && 'border-error')}
                            />
                            <span className="pointer-events-none absolute inset-y-0 right-3 flex items-center text-[12.5px] text-mocha">°C</span>
                        </div>
                        {errors.water_temp && <p className="text-[12px] font-medium text-error" role="alert">{errors.water_temp}</p>}
                    </div>
                </div>
