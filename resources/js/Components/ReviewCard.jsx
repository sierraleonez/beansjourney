	...
	return (
		<Card className="flex gap-4 p-5 sm:p-6">
			...
			<div className="min-w-0 flex-1">
				...
				{review.brew_method && (
					<p className="mt-3 text-[12px] font-semibold text-caramel">
						Diseduh dengan: {review.brew_method}
					</p>
				)}
				<p className="mt-2 whitespace-pre-line text-[14px] leading-relaxed text-espresso">
					{review.body}
				</p>
				<p className="mt-3 flex items-center gap-3 text-[12px] font-semibold text-mocha">
					<span>{review.votes_count} dukungan</span>
					<Link
						href={reviews.show.url(review.id)}
