		...
		<AppLayout>
			...
			<section className="py-8">
				...
				<p className="mt-1 text-[13px] text-mocha">
					oleh {bean.roastery?.name ?? "Roaster tidak diketahui"}
					{bean.roastery?.location ? ` · ${bean.roastery.location}` : ""}
				</p>
							...
							<div className="min-w-0 flex-1">
								...
								{recipe.process && (
									<div className="mt-5">
										...
										<p className="mt-1.5 whitespace-pre-line text-[14.5px] leading-relaxed">
											{recipe.process}
										</p>
									</div>
								)}
