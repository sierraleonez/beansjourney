...
export default function BeanEdit({
	...
	const keptCount = remainingPhotos.filter(
		(photo) => !removedIds.includes(photo.id),
	).length;
		...
		<AppLayout>
			...
			<section className="mx-auto max-w-2xl py-10">
				...
				<p className="mt-2 text-[14px] text-mocha">
					Perbarui detail {bean.name}. Roastery pemilik bean ini tidak bisa
					diubah dari sini.
				</p>
